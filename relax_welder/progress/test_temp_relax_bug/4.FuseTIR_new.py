...
class Module:
    ...
    def fused_dense_relu(input0: T.Buffer((T.int64(2073600), T.int64(64)), "float16"), param_0: T.Buffer((T.int64(64), T.int64(64)), "float16"), T_relu_intermediate: T.Buffer((T.int64(2073600), T.int64(64)), "float16")):
        T.func_attr({"dlight.tensorcore_prenormlized": T.bool(True), "op_pattern": 0, "target": T.target({"arch": "sm_80", "keys": ["cuda", "gpu"], "kind": "cuda", "max_num_threads": 1024, "tag": "", "thread_warp_size": 32}), "tir.noalias": T.bool(True)})
        # with T.block("root"):
    ...
    def fused_fused_dense_relu_fused_dense_relu(input: T.Buffer((T.int64(2073600), T.int64(64)), "float16"), func0_param: T.Buffer((T.int64(64), T.int64(64)), "float16"), func1_param: T.Buffer((T.int64(64), T.int64(64)), "float16"), T_relu_intermediate_intermediate_1: T.Buffer((T.int64(2073600), T.int64(64)), "float16")):
                                            ...
                                            for ax0_ax1_ax2_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                                for ax0_ax1_ax2_fused_4 in T.vectorized(T.int64(8)):
                                                    with T.block("param_0_reindex_shared.dyn"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(64), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1 * T.int64(512) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) // T.int64(32))
                                                        v2 = T.axis.spatial(T.int64(64), ax3_0_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1 * T.int64(512) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) % T.int64(32))
                                                        T.reads(func0_param[v1, v2])
                                                        T.writes(param_0_reindex_shared_dyn[v0, v1, v2])
                                                        T.block_attr({"permuted_layout": 1})
                                                        param_0_reindex_shared_dyn[v0, v1, v2] = func0_param[v1, v2]
                                for ax3_0_1 in range(T.int64(2)):
                                    for ax0_0, ax1_0 in T.grid(T.int64(3), T.int64(1)):
                                        with T.block("input0_reindex_shared.dyn_warp_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            ...
                                            for ax0_ax1_ax2_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                                for ax0_ax1_ax2_fused_4 in T.vectorized(T.int64(8)):
                                                    with T.block("param_0_reindex_shared.dyn_1"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(64), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1 * T.int64(512) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) // T.int64(32))
                                                        v2 = T.axis.spatial(T.int64(64), ax3_0_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1 * T.int64(512) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) % T.int64(32))
                                                        T.reads(func1_param[v1, v2])
                                                        T.writes(param_0_reindex_shared_dyn_1[v0, v1, v2])
                                                        T.block_attr({"permuted_layout": 1})
                                                        param_0_reindex_shared_dyn_1[v0, v1, v2] = func1_param[v1, v2]
                                for ax3_0_1 in range(T.int64(2)):
                                    for ax0_0, ax1_0 in T.grid(T.int64(3), T.int64(1)):
    ...
    @R.function
    def main(input: R.Tensor((2073600, 64), dtype="float16"), func0_param: R.Tensor((64, 64), dtype="float16"), func1_param: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        cls = Module
        with R.dataflow():
            gv = R.call_tir(cls.fused_fused_dense_relu_fused_dense_relu, (input, func0_param, func1_param), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            R.output(gv)
        return gv