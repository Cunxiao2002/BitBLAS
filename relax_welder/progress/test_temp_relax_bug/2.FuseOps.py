...
class Module:
    ...
    def fused_fused_dense_relu_fused_dense_relu(input: R.Tensor((2073600, 64), dtype="float16"), func0_param: R.Tensor((64, 64), dtype="float16"), func1_param: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        R.func_attr({"Primitive": 1})
        cls = Module
        with R.dataflow():
            lv = R.call_tir(cls.fused_dense_relu, (input, func0_param), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            gv = R.call_tir(cls.fused_dense_relu, (lv, func1_param), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            R.output(gv)
        return gv
    ...
    def main(input: R.Tensor((2073600, 64), dtype="float16"), func0_param: R.Tensor((64, 64), dtype="float16"), func1_param: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        cls = Module
        with R.dataflow():
            lv: R.Tensor((2073600, 64), dtype="float16") = cls.fused_fused_dense_relu_fused_dense_relu(input, func0_param, func1_param)
            gv: R.Tensor((2073600, 64), dtype="float16") = lv
            R.output(gv)
        return gv