...
@fused_fused_dense_relu_fused_dense_relu = primfn(p_input: handle, p_func0_param: handle, p_func1_param: handle, p_output0: handle) -> ()
  attr = {"tir.noalias": True}
  buffers = {input: Buffer(input_1: Pointer(float16), float16, [2073600i64, 64i64], []),
             func0_param: Buffer(func0_param_1: Pointer(float16), float16, [64i64, 64i64], []),
             func1_param: Buffer(func1_param_1: Pointer(float16), float16, [64i64, 64i64], []),
             T_relu_intermediate_intermediate_1: Buffer(T_relu_intermediate_2: Pointer(global float16), float16, [2073600i64, 64i64], [])}
  buffer_map = {p_input: input, p_func0_param: func0_param, p_func1_param: func1_param, p_output0: T_relu_intermediate_intermediate_1} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
                        ...
                        for (ax0_ax1_ax2_fused_3_2: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 2073600i64, 64i64], "input0_reindex_shared.dyn") as [v0_3, v1_3, v2_3] {
                              ...
                              tir.reads([input[v1_3, v2_3]])
                              tir.writes([input0_reindex_shared_dyn_1[v0_3, v1_3, v2_3]])
                              tir.attrs({"permuted_layout": 1})
                              input0_reindex_shared_dyn_1[v0_3, v1_3, v2_3] = input[v1_3, v2_3]
                          }
                        }
                      }
                    }
                        ...
                        for (ax0_ax1_ax2_fused_3_3: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn") as [v0_4, v1_4, v2_4] {
                              ...
                              tir.reads([func0_param[v1_4, v2_4]])
                              tir.writes([param_0_reindex_shared_dyn_1[v0_4, v1_4, v2_4]])
                              tir.attrs({"permuted_layout": 1})
                              param_0_reindex_shared_dyn_1[v0_4, v1_4, v2_4] = func0_param[v1_4, v2_4]
                          }
                        }
                      }
                    }
                ...
                for (ax0_ax1_ax2_fused_1_5: int64, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_5: int64, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn") as [v0_5, v1_5, v2_5] {
                      ...
                      tir.writes([T_relu_intermediate_intermediate[v1_5, v2_5]])
                      T_relu_intermediate_intermediate[v1_5, v2_5] = max(T_matmul_NT_intermediate_reindex_shared_dyn_1[v0_5, v1_5, v2_5], 0f16)
                  }
                }
              }
            }
              ...
              for (ax2_0_2_2: int64, 0i64, 2i64) "thread_binding" {
                for (ax1_0_3_init_2: int64, 0i64, 3i64) {
                  for (ax2_0_3_init_2: int64, 0i64, 2i64) {
                    block([1i64, 129600i64, 4i64], "T_matmul_NT_o_init_1") as [v0_o_10, v1_o_10, v2_o_10] {
                      bind(v0_o_10, ax0_2)
                      ...
                      block([1i64, 1i64], "T_matmul_NT_init_o_1") as [v1_i_init_o_2, v2_i_init_o_2] {
                      ...
                      for (ax0_ax1_ax2_fused_2_6: int64, 0i64, 3i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_4: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_4: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 2073600i64, 64i64], "input0_reindex_shared.dyn_1") as [v0_6, v1_6, v2_6] {
                              bind(v0_6, 0i64)
                              ...
                              tir.reads([T_relu_intermediate_intermediate[v1_6, v2_6]])
                              tir.writes([input0_reindex_shared_dyn_2[v0_6, v1_6, v2_6]])
                              tir.attrs({"permuted_layout": 1})
                              input0_reindex_shared_dyn_2[v0_6, v1_6, v2_6] = T_relu_intermediate_intermediate[v1_6, v2_6]
                          }
                        }
                      }
                    }
                      ...
                      for (ax0_ax1_ax2_fused_2_7: int64, 0i64, 2i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_5: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_5: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn_1") as [v0_7, v1_7, v2_7] {
                              bind(v0_7, 0i64)
                              ...
                              tir.reads([func1_param[v1_7, v2_7]])
                              tir.writes([param_0_reindex_shared_dyn_2[v0_7, v1_7, v2_7]])
                              tir.attrs({"permuted_layout": 1})
                              param_0_reindex_shared_dyn_2[v0_7, v1_7, v2_7] = func1_param[v1_7, v2_7]
                          }
                        }
                      }
                    }
                  ...
                  for (ax3_0_1_2: int64, 0i64, 2i64) {
                    for (ax0_0_6: int64, 0i64, 3i64) {
                      for (ax1_0_8: int64, 0i64, 1i64) {
                        block([1i64, 129600i64, 4i64], "input0_reindex_shared.dyn_warp_o_1") as [v0_o_11, v1_o_11, v2_o_11] {
                          bind(v0_o_11, 0i64)
                    ...
                    for (ax0_0_7: int64, 0i64, 2i64) {
                      for (ax1_0_9: int64, 0i64, 1i64) {
                        block([1i64, 4i64, 4i64], "param_0_reindex_shared.dyn_warp_o_1") as [v0_o_12, v1_o_12, v2_o_12] {
                          bind(v0_o_12, 0i64)
                    ...
                    for (ax1_0_3_2: int64, 0i64, 3i64) {
                      for (ax2_0_3_2: int64, 0i64, 2i64) {
                        block([1i64, 129600i64, 4i64, tir.reduce_axis(0i64, 4i64)], "T_matmul_NT_o_update_1") as [v0_o_13, v1_o_13, v2_o_13, v3_o_2] {
                          bind(v0_o_13, ax0_2)
                          ...
                          block([1i64, 1i64, tir.reduce_axis(0i64, 1i64)], "T_matmul_NT_o_1") as [v1_i_o_2, v2_i_o_2, v3_i_o_2] {
                            bind(v1_i_o_2, 0i64)
                            bind(v2_i_o_2, 0i64)
                            bind(v3_i_o_2, 0i64)
                            tir.reads([T_matmul_NT_intermediate_reindex_shared_dyn_warp_2[0i64, v1_o_13, v2_o_13, 0i64:32i64, 0i64:8i64], input0_reindex_shared_dyn_warp_2[0i64, v1_o_13, v3_o_2, 0i64:32i64, 0i64:8i64], param_0_reindex_shared_dyn_warp_2[0i64, v2_o_13, v3_o_2, 0i64:32i64, 0i64:8i64]])
                ...
                for (ax0_0_8: int64, 0i64, 3i64) {
                  for (ax1_0_10: int64, 0i64, 2i64) {
                    block([1i64, 129600i64, 4i64], "T_matmul_NT_intermediate_reindex_shared.dyn_warp_o_1") as [v0_o_14, v1_o_14, v2_o_14] {
                      bind(v0_o_14, 0i64)
              ...
              for (ax0_ax1_ax2_fused_0_8: int64, 0i64, 12i64) "unroll" {
                for (ax0_ax1_ax2_fused_1_8: int64, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_8: int64, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn_1") as [v0_8, v1_8, v2_8] {
                      bind(v0_8, 0i64)
                      ...
                      tir.writes([T_relu_intermediate_intermediate_1[v1_8, v2_8]])
                      T_relu_intermediate_intermediate_1[v1_8, v2_8] = max(T_matmul_NT_intermediate_reindex_shared_dyn_2[v0_8, v1_8, v2_8], 0f16)
                  }
                }
              }
            }
