#[version = "0.0.5"]
@fused_gemm_0_gemm_1 = primfn(p_A: handle, p_B: handle, p_D: handle, p_output0: handle) -> ()
  ...
  buffers = {A: Buffer(A_1: Pointer(float16), float16, [512i64, 128i64], []),
             ...
             C_intermediate_1: Buffer(C: Pointer(global float16), float16, [512i64, 128i64], [])}
  buffer_map = {p_A: A, p_B: B, p_D: D, p_output0: C_intermediate_1} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
...
@gemm_0 = primfn(A_handle: handle, B_handle: handle, C_handle: handle) -> ()
  ...
  block([], "root") {
    ...
    B_reindex_shared_dyn_2 = alloc_buffer(float16[1, 128, 512])
    A_reindex_shared_dyn_warp_2 = alloc_buffer(float16[1, 32, 8, 32, 8])
    B_reindex_shared_dyn_warp_2 = alloc_buffer(float16[1, 8, 32, 32, 8])
    C_reindex_shared_dyn_2 = alloc_buffer(float16[1, 512, 512])
    C_reindex_shared_dyn_warp_2 = alloc_buffer(float16[1, 32, 32, 32, 8])
          ...
          for (ax1_0_2_2: int32, 0, 1) "thread_binding" {
            for (ax2_0_2_2: int32, 0, 4) "thread_binding" {
              for (ax1_0_3_init_2: int32, 0, 1) {
                for (ax2_0_3_init_2: int32, 0, 8) {
                  block([1, 32, 32], "gemm_o_init") as [v0_o_10, v1_o_10, v2_o_10] {
                    bind(v0_o_10, ax0_2)
                    bind(v1_o_10, ((ax1_0_0_ax2_0_0_fused_2 + ax1_0_2_2) + ax1_0_3_init_2))
                    bind(v2_o_10, ((ax2_0_2_2*8) + ax2_0_3_init_2))
                    tir.reads([])
              ...
              for (ax3_0_0_2: int32, 0, 1) {
                      ...
                      for (ax0_ax1_ax2_fused_3_4: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_4: int32, 0, 8) "vectorized" {
                          block([1, 512, 128], "A_reindex_shared.dyn") as [v0_6, v1_6, v2_6] {
                            ...
                            tir.reads([A_2[v1_6, v2_6]])
                            tir.writes([A_reindex_shared_dyn_2[v0_6, v1_6, v2_6]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            A_reindex_shared_dyn_2[v0_6, v1_6, v2_6] = A_2[v1_6, v2_6]
                        }
                      }
                    }
                  }
                ...
                for (ax0_ax1_ax2_fused_0_7: int32, 0, 1) "thread_binding" {
                  for (ax0_ax1_ax2_fused_1_7: int32, 0, 4) "thread_binding" {
                    for (ax0_ax1_ax2_fused_2_7: int32, 0, 64) "unroll" {
                      for (ax0_ax1_ax2_fused_3_5: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_5: int32, 0, 8) "vectorized" {
                          block([1, 128, 512], "B_reindex_shared.dyn") as [v0_7, v1_7, v2_7] {
                            bind(v0_7, 0)
                            bind(v1_7, floordiv((((((ax0_ax1_ax2_fused_0_7*65536) + (ax0_ax1_ax2_fused_1_7*16384)) + (ax0_ax1_ax2_fused_2_7*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 512))
                            bind(v2_7, floormod((((((ax0_ax1_ax2_fused_0_7*65536) + (ax0_ax1_ax2_fused_1_7*16384)) + (ax0_ax1_ax2_fused_2_7*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 512))
                            tir.reads([B_2[v1_7, v2_7]])
                            tir.writes([B_reindex_shared_dyn_2[v0_7, v1_7, v2_7]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            B_reindex_shared_dyn_2[v0_7, v1_7, v2_7] = B_2[v1_7, v2_7]
                        }
                      }
                    }
                  }
                ...
                for (ax3_0_1_2: int32, 0, 8) {
                  ...
                  for (ax0_0_7: int32, 0, 1) {
                    for (ax1_0_9: int32, 0, 8) {
                      block([1, 8, 32], "B_reindex_shared.dyn_warp_o") as [v0_o_12, v1_o_12, v2_o_12] {
                        bind(v0_o_12, 0)
                        bind(v1_o_12, (ax3_0_1_2 + ax0_0_7))
                        bind(v2_o_12, ((ax2_0_2_2*8) + ax1_0_9))
                  ...
                  for (ax1_0_3_2: int32, 0, 1) {
                    for (ax2_0_3_2: int32, 0, 8) {
                      block([1, 32, 32, tir.reduce_axis(0, 8)], "gemm_o_update") as [v0_o_13, v1_o_13, v2_o_13, v3_o_2] {
                        bind(v0_o_13, ax0_2)
                        bind(v1_o_13, ((ax1_0_0_ax2_0_0_fused_2 + ax1_0_2_2) + ax1_0_3_2))
                        bind(v2_o_13, ((ax2_0_2_2*8) + ax2_0_3_2))
              ...
              for (ax0_0_8: int32, 0, 1) {
                for (ax1_0_10: int32, 0, 8) {
                  block([1, 32, 32], "C_reindex_shared.dyn_warp_o") as [v0_o_14, v1_o_14, v2_o_14] {
                    bind(v0_o_14, 0)
                    bind(v1_o_14, ax1_0_0_ax2_0_0_fused_2)
                    bind(v2_o_14, ((ax2_0_2_2*8) + ax1_0_10))
            ...
            for (ax0_ax1_ax2_fused_0_8: int32, 0, 32) "unroll" {
              for (ax0_ax1_ax2_fused_1_8: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_8: int32, 0, 8) "vectorized" {
                  block([1, 512, 512], "C_reindex_shared.dyn") as [v0_8, v1_8, v2_8] {
                    bind(v0_8, 0)
                    bind(v1_8, ((ax1_0_0_ax2_0_0_fused_2*16) + floordiv((((ax0_ax1_ax2_fused_0_8*256) + (ax0_ax1_ax2_fused_1_8*8)) + ax0_ax1_ax2_fused_2_8), 512)))
                    bind(v2_8, floormod((((ax0_ax1_ax2_fused_0_8*256) + (ax0_ax1_ax2_fused_1_8*8)) + ax0_ax1_ax2_fused_2_8), 512))
                    tir.reads([C_reindex_shared_dyn_2[v0_8, v1_8, v2_8]])
                    tir.writes([C_2[v1_8, v2_8]])
                    C_2[v1_8, v2_8] = C_reindex_shared_dyn_2[v0_8, v1_8, v2_8]
                }
              }
            }
          }
...
@gemm_1 = primfn(A_handle_1: handle, B_handle_1: handle, C_handle_1: handle) -> ()
  ...
  block([], "root") {
    tir.reads([])
    tir.writes([])
    A_reindex_shared_dyn_3 = alloc_buffer(float16[1, 512, 512])
    B_reindex_shared_dyn_3 = alloc_buffer(float16[1, 512, 128])
    A_reindex_shared_dyn_warp_3 = alloc_buffer(float16[1, 32, 32, 32, 8])
    B_reindex_shared_dyn_warp_3 = alloc_buffer(float16[1, 32, 8, 32, 8])
    C_reindex_shared_dyn_3 = alloc_buffer(float16[1, 512, 128])
    C_reindex_shared_dyn_warp_3 = alloc_buffer(float16[1, 32, 8, 32, 8])
          ...
          for (ax1_0_2_3: int32, 0, 1) "thread_binding" {
            for (ax2_0_2_3: int32, 0, 4) "thread_binding" {
              for (ax1_0_3_init_3: int32, 0, 1) {
                for (ax2_0_3_init_3: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init") as [v0_o_15, v1_o_15, v2_o_15] {
                    bind(v0_o_15, ax0_3)
                    bind(v1_o_15, ((ax1_0_0_ax2_0_0_fused_3 + ax1_0_2_3) + ax1_0_3_init_3))
                    bind(v2_o_15, ((ax2_0_2_3*2) + ax2_0_3_init_3))
                    tir.reads([])
              ...
              for (ax3_0_0_3: int32, 0, 4) {
                    ...
                    for (ax0_ax1_ax2_fused_2_9: int32, 0, 2) "unroll" {
                      for (ax0_ax1_ax2_fused_3_6: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_6: int32, 0, 8) "vectorized" {
                          block([1, 512, 512], "A_reindex_shared.dyn") as [v0_9, v1_9, v2_9] {
                            bind(v0_9, 0)
                            ...
                            bind(v2_9, ((ax3_0_0_3*128) + floormod((((((ax0_ax1_ax2_fused_0_9*2048) + (ax0_ax1_ax2_fused_1_9*512)) + (ax0_ax1_ax2_fused_2_9*256)) + (ax0_ax1_ax2_fused_3_6*8)) + ax0_ax1_ax2_fused_4_6), 128)))
                            tir.reads([A_4[v1_9, v2_9]])
                            tir.writes([A_reindex_shared_dyn_3[v0_9, v1_9, v2_9]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            A_reindex_shared_dyn_3[v0_9, v1_9, v2_9] = A_4[v1_9, v2_9]
                        }
                      }
                    }
                  }
                ...
                for (ax0_ax1_ax2_fused_0_10: int32, 0, 1) "thread_binding" {
                  for (ax0_ax1_ax2_fused_1_10: int32, 0, 4) "thread_binding" {
                    for (ax0_ax1_ax2_fused_2_10: int32, 0, 16) "unroll" {
                      for (ax0_ax1_ax2_fused_3_7: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_7: int32, 0, 8) "vectorized" {
                          block([1, 512, 128], "B_reindex_shared.dyn") as [v0_10, v1_10, v2_10] {
                            bind(v0_10, 0)
                            bind(v1_10, ((ax3_0_0_3*128) + floordiv((((((ax0_ax1_ax2_fused_0_10*16384) + (ax0_ax1_ax2_fused_1_10*4096)) + (ax0_ax1_ax2_fused_2_10*256)) + (ax0_ax1_ax2_fused_3_7*8)) + ax0_ax1_ax2_fused_4_7), 128)))
                            bind(v2_10, floormod((((((ax0_ax1_ax2_fused_0_10*16384) + (ax0_ax1_ax2_fused_1_10*4096)) + (ax0_ax1_ax2_fused_2_10*256)) + (ax0_ax1_ax2_fused_3_7*8)) + ax0_ax1_ax2_fused_4_7), 128))
                            tir.reads([B_4[v1_10, v2_10]])
                            tir.writes([B_reindex_shared_dyn_3[v0_10, v1_10, v2_10]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            B_reindex_shared_dyn_3[v0_10, v1_10, v2_10] = B_4[v1_10, v2_10]
                        }
                      }
                    }
                  }
                ...
                for (ax3_0_1_3: int32, 0, 8) {
                  for (ax0_0_9: int32, 0, 1) {
                    for (ax1_0_11: int32, 0, 1) {
                      block([1, 32, 32], "A_reindex_shared.dyn_warp_o") as [v0_o_16, v1_o_16, v2_o_16] {
                        bind(v0_o_16, 0)
                        bind(v1_o_16, (ax1_0_0_ax2_0_0_fused_3 + ax0_0_9))
                        bind(v2_o_16, (((ax3_0_0_3*8) + ax3_0_1_3) + ax1_0_11))
                  ...
                  for (ax0_0_10: int32, 0, 1) {
                    for (ax1_0_12: int32, 0, 2) {
                      block([1, 32, 8], "B_reindex_shared.dyn_warp_o") as [v0_o_17, v1_o_17, v2_o_17] {
                        bind(v0_o_17, 0)
                        bind(v1_o_17, (((ax3_0_0_3*8) + ax3_0_1_3) + ax0_0_10))
                        bind(v2_o_17, ((ax2_0_2_3*2) + ax1_0_12))
                  ...
                  for (ax1_0_3_3: int32, 0, 1) {
                    for (ax2_0_3_3: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 32)], "gemm_o_update") as [v0_o_18, v1_o_18, v2_o_18, v3_o_3] {
                        bind(v0_o_18, ax0_3)
                        bind(v1_o_18, ((ax1_0_0_ax2_0_0_fused_3 + ax1_0_2_3) + ax1_0_3_3))
                        bind(v2_o_18, ((ax2_0_2_3*2) + ax2_0_3_3))
              ...
              for (ax0_0_11: int32, 0, 1) {
                for (ax1_0_13: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o") as [v0_o_19, v1_o_19, v2_o_19] {
                    bind(v0_o_19, 0)
                    bind(v1_o_19, ax1_0_0_ax2_0_0_fused_3)
                    bind(v2_o_19, ((ax2_0_2_3*2) + ax1_0_13))
            ...
            for (ax0_ax1_ax2_fused_0_11: int32, 0, 8) "unroll" {
              for (ax0_ax1_ax2_fused_1_11: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_11: int32, 0, 8) "vectorized" {
                  block([1, 512, 128], "C_reindex_shared.dyn") as [v0_11, v1_11, v2_11] {
                    bind(v0_11, 0)
                    bind(v1_11, ((ax1_0_0_ax2_0_0_fused_3*16) + floordiv((((ax0_ax1_ax2_fused_0_11*256) + (ax0_ax1_ax2_fused_1_11*8)) + ax0_ax1_ax2_fused_2_11), 128)))
                    bind(v2_11, floormod((((ax0_ax1_ax2_fused_0_11*256) + (ax0_ax1_ax2_fused_1_11*8)) + ax0_ax1_ax2_fused_2_11), 128))
                    tir.reads([C_reindex_shared_dyn_3[v0_11, v1_11, v2_11]])
                    tir.writes([C_4[v1_11, v2_11]])
                    C_4[v1_11, v2_11] = C_reindex_shared_dyn_3[v0_11, v1_11, v2_11]
                }
              }
            }
          }
