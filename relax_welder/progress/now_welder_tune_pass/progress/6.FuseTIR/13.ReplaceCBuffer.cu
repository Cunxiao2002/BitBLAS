              ...
              for (ax0_ax1_ax2_fused_1_3: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_3: int32, 0, 8) "vectorized" {
                  block([1, 512, 512], "C_reindex_shared.dyn") as [v0_3, v1_3, v2_3] {
                    ...
                    tir.writes([C_intermediate: Buffer(C_intermediate_2: Pointer(global float16), float16, [512i64, 512i64], [])[v1_3, v2_3]])
                    C_intermediate[v1_3, v2_3] = C_reindex_shared_dyn_1[v0_3, v1_3, v2_3]
                }
              }
            }
          }
