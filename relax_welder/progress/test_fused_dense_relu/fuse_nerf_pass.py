...
class Module:
    ...
    @R.function
    def main(input0: R.Tensor((2073600, 64), "float16"), param_0: R.Tensor((64, 64), "float16"), param_1: R.Tensor((64, 64), "float16")) -> (R.Tensor((2073600, 64), "float16")):
        with R.dataflow():
            lv0 = R.call_tir(Module.fused_dense_relu_0, (input0, param_0), out_sinfo=R.Tensor((2073600, 64), "float16"))
            lv1 = R.call_tir(Module.fused_dense_relu_1, (lv0, param_1), out_sinfo=R.Tensor((2073600, 64), "float16"))
            R.output(lv1)
