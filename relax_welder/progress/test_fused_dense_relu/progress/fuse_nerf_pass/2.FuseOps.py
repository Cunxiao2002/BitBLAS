...
class Module:
    ...
    def fused_fused_dense_relu_0_fused_dense_relu_1(input0: R.Tensor((2073600, 64), dtype="float16"), param_0: R.Tensor((64, 64), dtype="float16"), param_1: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        R.func_attr({"Primitive": 1})
        cls = Module
        with R.dataflow():
            lv0 = R.call_tir(cls.fused_dense_relu_0, (input0, param_0), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            gv = R.call_tir(cls.fused_dense_relu_1, (lv0, param_1), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            R.output(gv)
        return gv
    ...
    def main(input0: R.Tensor((2073600, 64), dtype="float16"), param_0: R.Tensor((64, 64), dtype="float16"), param_1: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        cls = Module
        with R.dataflow():
            gv: R.Tensor((2073600, 64), dtype="float16") = cls.fused_fused_dense_relu_0_fused_dense_relu_1(input0, param_0, param_1)
            R.output(gv)
        return gv