...
extern "C" __global__ void __launch_bounds__(128) fused_gemm_kernel(half* __restrict__ T_relu_intermediate_intermediate_1, half* __restrict__ input0, half* __restrict__ param_0, half* __restrict__ param_1);
extern "C" __global__ void __launch_bounds__(128) fused_gemm_kernel(half* __restrict__ T_relu_intermediate_intermediate_1, half* __restrict__ input0, half* __restrict__ param_0, half* __restrict__ param_1) {
  extern __shared__ uchar buf_dyn_shmem[];
  half T_matmul_NT_intermediate_reindex_shared_dyn_warp[96];
  half input0_reindex_shared_dyn_warp[24];
  half param_0_reindex_shared_dyn_warp[16];
  half T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[48];
...
;
  ...
  for (int ax3_0_0 = 0; ax3_0_0 < 2; ++ax3_0_0) {
    __syncthreads();
    #pragma unroll
    for (int64_t ax0_ax1_ax2_fused_2 = 0; ax0_ax1_ax2_fused_2 < (int64_t)3; ++ax0_ax1_ax2_fused_2) {
      *(uint4*)(((half*)buf_dyn_shmem) + ((((((((int64_t)threadIdx.y) * (int64_t)1536) + (((int64_t)threadIdx.z) * (int64_t)768)) + (ax0_ax1_ax2_fused_2 * (int64_t)256)) + ((((int64_t)threadIdx.x) >> (int64_t)2) * (int64_t)32)) + (((((int64_t)threadIdx.x) & (int64_t)3) ^ (((int64_t)threadIdx.x) >> (int64_t)3)) * (int64_t)8)) + (int64_t)2048)) = *(uint4*)(input0 + (((((((((int64_t)((int)blockIdx.y)) * (int64_t)6144) + (((int64_t)threadIdx.y) * (int64_t)3072)) + (((int64_t)threadIdx.z) * (int64_t)1536)) + (ax0_ax1_ax2_fused_2 * (int64_t)512)) + ((((int64_t)threadIdx.x) >> (int64_t)2) * (int64_t)64)) + (((int64_t)ax3_0_0) * (int64_t)32)) + ((((int64_t)threadIdx.x) & (int64_t)3) * (int64_t)8)));
    }
    #pragma unroll
    for (int64_t ax0_ax1_ax2_fused_2_1 = 0; ax0_ax1_ax2_fused_2_1 < (int64_t)2; ++ax0_ax1_ax2_fused_2_1) {
      *(uint4*)(((half*)buf_dyn_shmem) + ((((((((int64_t)threadIdx.y) * (int64_t)1024) + (((int64_t)threadIdx.z) * (int64_t)512)) + (ax0_ax1_ax2_fused_2_1 * (int64_t)256)) + ((((int64_t)threadIdx.x) >> (int64_t)2) * (int64_t)32)) + (((((int64_t)threadIdx.x) & (int64_t)3) ^ (((int64_t)threadIdx.x) >> (int64_t)3)) * (int64_t)8)) + (int64_t)5120)) = *(uint4*)(param_0 + ((((((((int64_t)threadIdx.y) * (int64_t)2048) + (((int64_t)threadIdx.z) * (int64_t)1024)) + (ax0_ax1_ax2_fused_2_1 * (int64_t)512)) + ((((int64_t)threadIdx.x) >> (int64_t)2) * (int64_t)64)) + (((int64_t)ax3_0_0) * (int64_t)32)) + ((((int64_t)threadIdx.x) & (int64_t)3) * (int64_t)8)));
    }
    __syncthreads();
    for (int64_t ax3_0_1 = 0; ax3_0_1 < (int64_t)2; ++ax3_0_1) {
      for (int64_t ax0_0 = 0; ax0_0 < (int64_t)3; ++ax0_0) {

  {
    unsigned int addr;
#if TVM_ENBALE_EFFICIENT_SMEM_PTR_CAST
    addr = static_cast<unsigned int>(__cvta_generic_to_shared((void *)((&(((half*)buf_dyn_shmem)[(((((((int64_t)threadIdx.y) * (int64_t)1536) + (ax0_0 * (int64_t)512)) + ((((int64_t)threadIdx.x) & (int64_t)15) * (int64_t)32)) + ((((ax3_0_1 * (int64_t)2) + (((int64_t)threadIdx.x) >> (int64_t)4)) ^ ((((int64_t)threadIdx.x) & (int64_t)7) >> (int64_t)1)) * (int64_t)8)) + (int64_t)2048)])) + 0)));
#else
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)((&(((half*)buf_dyn_shmem)[(((((((int64_t)threadIdx.y) * (int64_t)1536) + (ax0_0 * (int64_t)512)) + ((((int64_t)threadIdx.x) & (int64_t)15) * (int64_t)32)) + ((((ax3_0_1 * (int64_t)2) + (((int64_t)threadIdx.x) >> (int64_t)4)) ^ ((((int64_t)threadIdx.x) & (int64_t)7) >> (int64_t)1)) * (int64_t)8)) + (int64_t)2048)])) + 0))
    );
#endif
    __asm__ __volatile__(
...

  {
    unsigned int addr;
#if TVM_ENBALE_EFFICIENT_SMEM_PTR_CAST
    addr = static_cast<unsigned int>(__cvta_generic_to_shared((void *)((&(((half*)buf_dyn_shmem)[((((((((int64_t)threadIdx.z) * (int64_t)1024) + (ax0_0_1 * (int64_t)512)) + ((((int64_t)threadIdx.x) >> (int64_t)4) * (int64_t)256)) + ((((int64_t)threadIdx.x) & (int64_t)7) * (int64_t)32)) + ((((ax3_0_1 * (int64_t)2) + ((((int64_t)threadIdx.x) & (int64_t)15) >> (int64_t)3)) ^ ((((int64_t)threadIdx.x) & (int64_t)7) >> (int64_t)1)) * (int64_t)8)) + (int64_t)5120)])) + 0)));
#else
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)((&(((half*)buf_dyn_shmem)[((((((((int64_t)threadIdx.z) * (int64_t)1024) + (ax0_0_1 * (int64_t)512)) + ((((int64_t)threadIdx.x) >> (int64_t)4) * (int64_t)256)) + ((((int64_t)threadIdx.x) & (int64_t)7) * (int64_t)32)) + ((((ax3_0_1 * (int64_t)2) + ((((int64_t)threadIdx.x) & (int64_t)15) >> (int64_t)3)) ^ ((((int64_t)threadIdx.x) & (int64_t)7) >> (int64_t)1)) * (int64_t)8)) + (int64_t)5120)])) + 0))
    );
#endif
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
...
;
  ...
  for (int ax0_ax1_ax2_fused_0 = 0; ax0_ax1_ax2_fused_0 < 12; ++ax0_ax1_ax2_fused_0) {
    ...
    *(uint4*)(((half*)buf_dyn_shmem) + ((((((int64_t)threadIdx.y) * (int64_t)3072) + (((int64_t)ax0_ax1_ax2_fused_0) * (int64_t)256)) + (((int64_t)threadIdx.x) * (int64_t)8)) + (int64_t)2048)) = __1;
  }
  for (int ax1_0_3_init_1 = 0; ax1_0_3_init_1 < 3; ++ax1_0_3_init_1) {
...
;
...

  {
    unsigned int addr;
#if TVM_ENBALE_EFFICIENT_SMEM_PTR_CAST
    addr = static_cast<unsigned int>(__cvta_generic_to_shared((void *)((&(((half*)buf_dyn_shmem)[(((((((int64_t)threadIdx.y) * (int64_t)3072) + (((int64_t)ax0_0_3) * (int64_t)1024)) + (((int64_t)ax3_0_0_1) * (int64_t)32)) + (ax3_0_1_1 * (int64_t)16)) + (int64_t)2048)])) + (((((int64_t)threadIdx.x) & (int64_t)15) * (int64_t)64) + ((((int64_t)threadIdx.x) >> (int64_t)4) * (int64_t)8)))));
#else
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)((&(((half*)buf_dyn_shmem)[(((((((int64_t)threadIdx.y) * (int64_t)3072) + (((int64_t)ax0_0_3) * (int64_t)1024)) + (((int64_t)ax3_0_0_1) * (int64_t)32)) + (ax3_0_1_1 * (int64_t)16)) + (int64_t)2048)])) + (((((int64_t)threadIdx.x) & (int64_t)15) * (int64_t)64) + ((((int64_t)threadIdx.x) >> (int64_t)4) * (int64_t)8))))
    );
#endif
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
  ...
  for (int ax0_0_5 = 0; ax0_0_5 < 3; ++ax0_0_5) {
    for (int ax1_0_1 = 0; ax1_0_1 < 2; ++ax1_0_1) {
      for (int local_id = 0; local_id < 8; local_id+=2) {
*((uint *)&(&(((half*)buf_dyn_shmem)[(((((((int64_t)threadIdx.y) * (int64_t)3072) + (((int64_t)ax0_0_5) * (int64_t)1024)) + (((int64_t)threadIdx.z) * (int64_t)32)) + (((int64_t)ax1_0_1) * (int64_t)16)) + (int64_t)2048)]))[((((((local_id % 4) / 2) * 8) + (threadIdx.x / 4)) * 64) + ((((local_id / 4) * 8) + ((threadIdx.x % 4) * 2)) + (local_id % 2)))]) = *((uint *)&T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[((ax0_0_5 * 16) + (ax1_0_1 * 8)) + local_id]);
}
;
    }
  }
  __syncthreads();
  #pragma unroll
  for (int ax0_ax1_ax2_fused_0_1 = 0; ax0_ax1_ax2_fused_0_1 < 12; ++ax0_ax1_ax2_fused_0_1) {
    uint4 __2;
      uint4 v__2 = *(uint4*)(((half*)buf_dyn_shmem) + ((((((int64_t)threadIdx.y) * (int64_t)3072) + (((int64_t)ax0_ax1_ax2_fused_0_1) * (int64_t)256)) + (((int64_t)threadIdx.x) * (int64_t)8)) + (int64_t)2048));
    ...
    *(uint4*)(T_relu_intermediate_intermediate_1 + ((((((int64_t)((int)blockIdx.y)) * (int64_t)6144) + (((int64_t)threadIdx.y) * (int64_t)3072)) + (((int64_t)ax0_ax1_ax2_fused_0_1) * (int64_t)256)) + (((int64_t)threadIdx.x) * (int64_t)8))) = __2;
  }
}
...
// CPU 参考实现
void cpu_reference(const half* input, const half* weights1, const half* weights2, 
                  half* output, int batch_size, int in_features, int hidden_features, 
                  int out_features) {
    std::vector<float> hidden(batch_size * hidden_features, 0.0f);
    ...
    for (int b = 0; b < batch_size; b++) {
        for (int j = 0; j < hidden_features; j++) {
            ...
            for (int k = 0; k < in_features; k++) {
                sum += __half2float(input[b * in_features + k]) * 
                       __half2float(weights1[k * hidden_features + j]);
            }
            hidden[b * hidden_features + j] = std::max(0.0f, sum);
        }
    }
    ...
    for (int b = 0; b < batch_size; b++) {
        for (int j = 0; j < out_features; j++) {
            ...
            for (int k = 0; k < hidden_features; k++) {
                sum += hidden[b * hidden_features + k] * 
                       __half2float(weights2[k * out_features + j]);
            }
            output[b * out_features + j] = __float2half(std::max(0.0f, sum));
        }
    }
}
...
int main() {
    ...
    size_t weights1_size = in_features * hidden_features;
    size_t weights2_size = hidden_features * out_features;
    size_t output_size = batch_size * out_features;
    
    std::vector<half> h_input(input_size);
    std::vector<half> h_weights1(weights1_size);
    std::vector<half> h_weights2(weights2_size);
    std::vector<half> h_output(output_size);
    std::vector<half> h_ref_output(output_size);
    ...
    for (size_t i = 0; i < weights1_size; i++) {
        h_weights1[i] = __float2half(dist(gen) * 0.1f); // 缩小权重范围避免溢出
    }
    for (size_t i = 0; i < weights2_size; i++) {
        h_weights2[i] = __float2half(dist(gen) * 0.1f);
    }
    
    // 计算参考输出（仅对小批量进行验证，全部验证太慢）
    const int validation_batch = std::min(100, batch_size);
    cpu_reference(h_input.data(), h_weights1.data(), h_weights2.data(), 
                 h_ref_output.data(), validation_batch, in_features, hidden_features, out_features);
    
    // 分配设备内存
    half *d_input, *d_weights1, *d_weights2, *d_output;
    cudaMalloc(&d_input, input_size * sizeof(half));
    cudaMalloc(&d_weights1, weights1_size * sizeof(half));
    cudaMalloc(&d_weights2, weights2_size * sizeof(half));
    cudaMalloc(&d_output, output_size * sizeof(half));
    
    // 将数据复制到设备
    cudaMemcpy(d_input, h_input.data(), input_size * sizeof(half), cudaMemcpyHostToDevice);
    cudaMemcpy(d_weights1, h_weights1.data(), weights1_size * sizeof(half), cudaMemcpyHostToDevice);
    cudaMemcpy(d_weights2, h_weights2.data(), weights2_size * sizeof(half), cudaMemcpyHostToDevice);
    
    // 计算网格维度 (从代码片段中推断)
    // 从代码中推断出每个块处理 6144/64 = 96 个样本
    int samples_per_block = 96;
    int grid_y = (batch_size + samples_per_block - 1) / samples_per_block;
    
    dim3 blockDim(32, 2, 2);  // 从代码分析推断
    dim3 gridDim(1, grid_y, 1);
    
    // 估计共享内存大小 (基于代码中的偏移量)
    size_t sharedMemSize = 8192;  // 保守估计，从代码分析推断
    ...
    fused_fused_dense_relu_fused_dense_relu_kernel<<<gridDim, blockDim, sharedMemSize>>>(
        d_output, d_input, d_weights1, d_weights2);
    ...
    // 复制结果回主机
    cudaMemcpy(h_output.data(), d_output, output_size * sizeof(half), cudaMemcpyDeviceToHost);
    
    // 验证结果正确性 (仅对小批量)
    bool correct = true;
    float max_diff = 0.0f;
    for (int i = 0; i < validation_batch * out_features; i++) {
        float diff = std::abs(__half2float(h_output[i]) - __half2float(h_ref_output[i]));
        max_diff = std::max(max_diff, diff);
        if (diff > 0.01f) {  // 允许小误差
            correct = false;
            std::cout << "Mismatch at index " << i << ": " 
                      << __half2float(h_output[i]) << " vs " 
                      << __half2float(h_ref_output[i]) << std::endl;
            break;
        }
    }
    
    // 输出性能统计
    double ops = 2.0 * batch_size * in_features * hidden_features + 
                 2.0 * batch_size * hidden_features * out_features;
    double gflops = (ops * num_runs) / (milliseconds * 1e6);
    
    std::cout << "Kernel execution time: " << milliseconds / num_runs << " ms" << std::endl;
    ...
    std::cout << "ncu --metrics sm__sass_thread_inst_executed_op_ffma_pred_on.sum,dram__bytes_read.sum,dram__bytes_write.sum,sm__warps_active.avg.pct_of_peak_sustained_active ./test_kernel" << std::endl;
