#[version = "0.0.5"]
@fused_fused_dense_relu_0_fused_dense_relu_1 = primfn(input0_handle: handle, param_0_handle: handle, param_1_handle: handle, T_relu_intermediate_intermediate_1_handle: handle) -> ()
  ...
  buffers = {input0: Buffer(input0_1: Pointer(global float16), float16, [2073600i64, 64i64], []),
             ...
             param_1: Buffer(param_1_1: Pointer(global float16), float16, [64i64, 64i64], []),
  ...
  buffer_map = {input0_handle: input0, param_0_handle: param_0, param_1_handle: param_1, T_relu_intermediate_intermediate_1_handle: T_relu_intermediate_intermediate_1} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
    ...
    T_matmul_NT_intermediate_reindex_shared_dyn_warp_1 = alloc_buffer(float16[1i64, 129600i64, 4i64, 32i64, 8i64])
     {
                ...
                for (ax0_ax1_ax2_fused_1_2: int64, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_2: int64, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn") as [v0_2, v1_2, v2_2] {
                      ...
                      tir.writes([T_relu_intermediate_intermediate[v1_2, v2_2]])
                      T_relu_intermediate_intermediate[v1_2, v2_2] = max(T_matmul_NT_intermediate_reindex_shared_dyn[v0_2, v1_2, v2_2], 0f16)
                  }
                }
              }
                ...
                for (ax1_0_3_init_1: int64, 0i64, 3i64) {
                  for (ax2_0_3_init_1: int64, 0i64, 2i64) {
                    block([1i64, 129600i64, 4i64], "T_matmul_NT_o_init_1") as [v0_o_5, v1_o_5, v2_o_5] {
                      bind(v0_o_5, ax0_1: int64)
                      bind(v1_o_5, (((ax1_0_0_ax2_0_0_fused_1: int64*6i64) + (ax1_0_2_1: int64*3i64)) + ax1_0_3_init_1))
                      ...
                      for (ax0_ax1_ax2_fused_2_3: int64, 0i64, 3i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_2: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 2073600i64, 64i64], "input0_reindex_shared.dyn_1") as [v0_3, v1_3, v2_3] {
                              bind(v0_3, 0i64)
                              ...
                              tir.reads([T_relu_intermediate_intermediate[v1_3, v2_3]])
                              tir.writes([input0_reindex_shared_dyn_1[v0_3, v1_3, v2_3]])
                              tir.attrs({"permuted_layout": 1})
                              input0_reindex_shared_dyn_1[v0_3, v1_3, v2_3] = T_relu_intermediate_intermediate[v1_3, v2_3]
                          }
                        }
                      }
                    }
                      ...
                      for (ax0_ax1_ax2_fused_2_4: int64, 0i64, 2i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_3: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn_1") as [v0_4, v1_4, v2_4] {
                              bind(v0_4, 0i64)
                              ...
                              tir.reads([param_1[v1_4, v2_4]])
                              tir.writes([param_0_reindex_shared_dyn_1[v0_4, v1_4, v2_4]])
                              tir.attrs({"permuted_layout": 1})
                              param_0_reindex_shared_dyn_1[v0_4, v1_4, v2_4] = param_1[v1_4, v2_4]
                          }
                        }
                      }
                    }
              ...
              for (ax0_ax1_ax2_fused_0_5: int64, 0i64, 12i64) "unroll" {
                for (ax0_ax1_ax2_fused_1_5: int64, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_5: int64, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn_1") as [v0_5, v1_5, v2_5] {
                      bind(v0_5, 0i64)
                      ...
                      tir.writes([T_relu_intermediate_intermediate_1[v1_5, v2_5]])
                      T_relu_intermediate_intermediate_1[v1_5, v2_5] = max(T_matmul_NT_intermediate_reindex_shared_dyn_1[v0_5, v1_5, v2_5], 0f16)
                  }
                }
              }
            }
      ...
      for (ax0_1, 0i64, 1i64) "thread_binding" {
        for (ax1_0_0_ax2_0_0_fused_1, 0i64, 21600i64) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused_1: int64, 0i64, 1i64) "thread_binding" {
            for (ax1_0_2_1, 0i64, 2i64) "thread_binding" {
              for (ax2_0_2_1, 0i64, 2i64) "thread_binding" {
                for (ax1_0_3_init_1, 0i64, 3i64) {
                  for (ax2_0_3_init_1, 0i64, 2i64) {
                    block([1i64, 129600i64, 4i64], "T_matmul_NT_o_init_1") as [v0_o_5, v1_o_5, v2_o_5] {
                      bind(v0_o_5, ax0_1)
                      ...
                      block([1i64, 1i64], "T_matmul_NT_init_o_1") as [v1_i_init_o_1, v2_i_init_o_1] {
                        ...
                        tir.writes([T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[0i64, v1_o_5, v2_o_5, 0i64:32i64, 0i64:8i64]])
                        C_warp_4 = match_buffer(T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[0i64, v1_o_5, v2_o_5, 0i64:32i64, 0i64:8i64])
                        for (tx_5, 0i64, 32i64) "thread_binding" {
                          @tir.mma_fill(8, C_warp_5, elem_offset_10, dtype=float16)
                        }
                  }
                }
                for (ax3_0_0_1, 0i64, 2i64) {
                  for (ax0_ax1_ax2_fused_0_3, 0i64, 2i64) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_3, 0i64, 2i64) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_3, 0i64, 3i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_2, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2, 0i64, 8i64) "vectorized" {
                            block([1i64, 2073600i64, 64i64], "input0_reindex_shared.dyn_1") as [v0_3, v1_3, v2_3] {
                              bind(v0_3, 0i64)
                              bind(v1_3, ((ax1_0_0_ax2_0_0_fused_1*96i64) + floordiv((((((ax0_ax1_ax2_fused_0_3*1536i64) + (ax0_ax1_ax2_fused_1_3*768i64)) + (ax0_ax1_ax2_fused_2_3*256i64)) + (ax0_ax1_ax2_fused_3_2*8i64)) + ax0_ax1_ax2_fused_4_2), 32i64)))
                              bind(v2_3, ((ax3_0_0_1*32i64) + floormod((((((ax0_ax1_ax2_fused_0_3*1536i64) + (ax0_ax1_ax2_fused_1_3*768i64)) + (ax0_ax1_ax2_fused_2_3*256i64)) + (ax0_ax1_ax2_fused_3_2*8i64)) + ax0_ax1_ax2_fused_4_2), 32i64)))
                  ...
                  for (ax0_ax1_ax2_fused_0_4, 0i64, 2i64) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_4, 0i64, 2i64) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_4, 0i64, 2i64) "unroll" {
                        for (ax0_ax1_ax2_fused_3_3, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3, 0i64, 8i64) "vectorized" {
                            block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn_1") as [v0_4, v1_4, v2_4] {
                              bind(v0_4, 0i64)
                              bind(v1_4, floordiv((((((ax0_ax1_ax2_fused_0_4*1024i64) + (ax0_ax1_ax2_fused_1_4*512i64)) + (ax0_ax1_ax2_fused_2_4*256i64)) + (ax0_ax1_ax2_fused_3_3*8i64)) + ax0_ax1_ax2_fused_4_3), 32i64))
                              bind(v2_4, ((ax3_0_0_1*32i64) + floormod((((((ax0_ax1_ax2_fused_0_4*1024i64) + (ax0_ax1_ax2_fused_1_4*512i64)) + (ax0_ax1_ax2_fused_2_4*256i64)) + (ax0_ax1_ax2_fused_3_3*8i64)) + ax0_ax1_ax2_fused_4_3), 32i64)))
                  ...
                  for (ax3_0_1_1, 0i64, 2i64) {
                    for (ax0_0_3, 0i64, 3i64) {
                      for (ax1_0_5, 0i64, 1i64) {
                        block([1i64, 129600i64, 4i64], "input0_reindex_shared.dyn_warp_o_1") as [v0_o_6, v1_o_6, v2_o_6] {
                          bind(v0_o_6, 0i64)
                          bind(v1_o_6, (((ax1_0_0_ax2_0_0_fused_1*6i64) + (ax1_0_2_1*3i64)) + ax0_0_3))
                          bind(v2_o_6, (((ax3_0_0_1*2i64) + ax3_0_1_1) + ax1_0_5))
                          ...
                          warp_4 = match_buffer(input0_reindex_shared_dyn_warp_1[v0_o_6, v1_o_6, v2_o_6, 0i64:32i64, 0i64:8i64])
                          shared_4 = match_buffer(input0_reindex_shared_dyn_1[v0_o_6, (v1_o_6*16i64):((v1_o_6*16i64) + 16i64), (v2_o_6*16i64):((v2_o_6*16i64) + 16i64)])
                          for (tx_6, 0i64, 32i64) "thread_binding" {
                            @tir.ptx_ldmatrix(False, 4, ".b16", warp_5, (elem_offset_11 + (8i64*tx_6)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_5, elem_offset_12, (shared_s0_2*16i64), 1, dtype=handle), ((shared_s0_2*floormod(tx_6, 16i64)) + (8i64*floordiv(tx_6, 16i64))), dtype=float16)
                          }
                      }
                    }
                    for (ax0_0_4, 0i64, 2i64) {
                      for (ax1_0_6, 0i64, 1i64) {
                        block([1i64, 4i64, 4i64], "param_0_reindex_shared.dyn_warp_o_1") as [v0_o_7, v1_o_7, v2_o_7] {
                          bind(v0_o_7, 0i64)
                          bind(v1_o_7, ((ax2_0_2_1*2i64) + ax0_0_4))
                          bind(v2_o_7, (((ax3_0_0_1*2i64) + ax3_0_1_1) + ax1_0_6))
                          ...
                          warp_6 = match_buffer(param_0_reindex_shared_dyn_warp_1[v0_o_7, v1_o_7, v2_o_7, 0i64:32i64, 0i64:8i64])
                          shared_6 = match_buffer(param_0_reindex_shared_dyn_1[v0_o_7, (v1_o_7*16i64):((v1_o_7*16i64) + 16i64), (v2_o_7*16i64):((v2_o_7*16i64) + 16i64)])
                          for (tx_7, 0i64, 32i64) "thread_binding" {
                            @tir.ptx_ldmatrix(False, 4, ".b16", warp_7, (elem_offset_13 + (8i64*tx_7)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_7, elem_offset_14, (shared_s0_3*16i64), 1, dtype=handle), ((((shared_s0_3*8i64)*floordiv(tx_7, 16i64)) + (shared_s0_3*floormod(tx_7, 8i64))) + (8i64*floordiv(floormod(tx_7, 16i64), 8i64))), dtype=float16)
                          }
                      }
                    }
                    for (ax1_0_3_1, 0i64, 3i64) {
                      for (ax2_0_3_1, 0i64, 2i64) {
                        block([1i64, 129600i64, 4i64, tir.reduce_axis(0i64, 4i64)], "T_matmul_NT_o_update_1") as [v0_o_8, v1_o_8, v2_o_8, v3_o_1] {
                          bind(v0_o_8, ax0_1)
                          bind(v1_o_8, (((ax1_0_0_ax2_0_0_fused_1*6i64) + (ax1_0_2_1*3i64)) + ax1_0_3_1))
                          bind(v2_o_8, ((ax2_0_2_1*2i64) + ax2_0_3_1))
                          ...
                          block([1i64, 1i64, tir.reduce_axis(0i64, 1i64)], "T_matmul_NT_o_1") as [v1_i_o_1, v2_i_o_1, v3_i_o_1] {
                            ...
                            B_2 = match_buffer(param_0_reindex_shared_dyn_warp_1[0i64, v2_o_8, v3_o_1, 0i64:32i64, 0i64:8i64])
                            C_4 = match_buffer(T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[0i64, v1_o_8, v2_o_8, 0i64:32i64, 0i64:8i64])
                            for (tx_8, 0i64, 32i64) "thread_binding" {
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_3, (elem_offset_15 + (tx_8*8i64)), B_3, (elem_offset_16 + (tx_8*8i64)), C_5, (elem_offset_17 + (tx_8*8i64)), False, dtype=float16)
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_3, (elem_offset_15 + (tx_8*8i64)), B_3, ((elem_offset_16 + (tx_8*8i64)) + 4i64), C_5, ((elem_offset_17 + (tx_8*8i64)) + 4i64), False, dtype=float16)
                            }
                      }
                    }
                ...
                for (ax0_0_5, 0i64, 3i64) {
                  for (ax1_0_7, 0i64, 2i64) {
                    block([1i64, 129600i64, 4i64], "T_matmul_NT_intermediate_reindex_shared.dyn_warp_o_1") as [v0_o_9, v1_o_9, v2_o_9] {
                      bind(v0_o_9, 0i64)
                      bind(v1_o_9, (((ax1_0_0_ax2_0_0_fused_1*6i64) + (ax1_0_2_1*3i64)) + ax0_0_5))
                      bind(v2_o_9, ((ax2_0_2_1*2i64) + ax1_0_7))
                      ...
                      C_warp_6 = match_buffer(T_matmul_NT_intermediate_reindex_shared_dyn_warp_1[v0_o_9, v1_o_9, v2_o_9, 0i64:32i64, 0i64:8i64])
                      C_6 = match_buffer(T_matmul_NT_intermediate_reindex_shared_dyn_1[v0_o_9, (v1_o_9*16i64):((v1_o_9*16i64) + 16i64), (v2_o_9*16i64):((v2_o_9*16i64) + 16i64)])
                      for (tx_9, 0i64, 32i64) "thread_binding" {
                        @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_7, elem_offset_18, (C_s0_1*16i64), 2, dtype=handle), C_warp_7, elem_offset_19, C_s0_1, dtype=float16)
                      }
                  }
                }
              }
              for (ax0_ax1_ax2_fused_0_5, 0i64, 12i64) "unroll" {
                for (ax0_ax1_ax2_fused_1_5, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_5, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn_1") as [v0_5, v1_5, v2_5] {
                      bind(v0_5, 0i64)
                      bind(v1_5, (((ax1_0_0_ax2_0_0_fused_1*96i64) + (ax1_0_2_1*48i64)) + floordiv((((ax0_ax1_ax2_fused_0_5*256i64) + (ax0_ax1_ax2_fused_1_5*8i64)) + ax0_ax1_ax2_fused_2_5), 64i64)))
                      bind(v2_5, floormod((((ax0_ax1_ax2_fused_0_5*256i64) + (ax0_ax1_ax2_fused_1_5*8i64)) + ax0_ax1_ax2_fused_2_5), 64i64))
