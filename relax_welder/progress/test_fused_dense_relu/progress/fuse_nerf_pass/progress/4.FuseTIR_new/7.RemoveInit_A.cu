        ...
        for (ax1_0_0_ax2_0_0_fused: int64, 0i64, 21600i64) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused: int64, 0i64, 1i64) "thread_binding" {
            for (ax1_0_2: int64, 0i64, 2i64) "thread_binding" {
                        ...
                        for (ax0_ax1_ax2_fused_3_2: int64, 0i64, 32i64) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2: int64, 0i64, 8i64) "vectorized" {
                            block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn_1") as [v0_3, v1_3, v2_3] {
                              ...
                              tir.reads([param_1[v1_3, v2_3]])
                              tir.writes([param_0_reindex_shared_dyn_1[v0_3, v1_3, v2_3]])
                              tir.attrs({"permuted_layout": 1})
                              param_0_reindex_shared_dyn_1[v0_3, v1_3, v2_3] = param_1[v1_3, v2_3]
                          }
                        }
                      }
                    }
              ...
              for (ax0_ax1_ax2_fused_0_4: int64, 0i64, 12i64) "unroll" {
                for (ax0_ax1_ax2_fused_1_4: int64, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_4: int64, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn_1") as [v0_4, v1_4, v2_4] {
                      bind(v0_4, 0i64)
                      bind(v1_4, (((ax1_0_0_ax2_0_0_fused_1*96i64) + (ax1_0_2_1*48i64)) + floordiv((((ax0_ax1_ax2_fused_0_4*256i64) + (ax0_ax1_ax2_fused_1_4*8i64)) + ax0_ax1_ax2_fused_2_4), 64i64)))
        ...
        for (ax1_0_0_ax2_0_0_fused_1, 0i64, 21600i64) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused_1: int64, 0i64, 1i64) "thread_binding" {
            for (ax1_0_2_1, 0i64, 2i64) "thread_binding" {
                ...
                for (ax3_0_0_1, 0i64, 2i64) {
                  for (ax0_ax1_ax2_fused_0_3, 0i64, 2i64) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_3, 0i64, 2i64) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_3, 0i64, 2i64) "unroll" {
              ...
              for (ax0_ax1_ax2_fused_0_4, 0i64, 12i64) "unroll" {
                for (ax0_ax1_ax2_fused_1_4, 0i64, 32i64) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_4, 0i64, 8i64) "vectorized" {
                    block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn_1") as [v0_4, v1_4, v2_4] {
                      bind(v0_4, 0i64)
                      bind(v1_4, (((ax1_0_0_ax2_0_0_fused_1*96i64) + (ax1_0_2_1*48i64)) + floordiv((((ax0_ax1_ax2_fused_0_4*256i64) + (ax0_ax1_ax2_fused_1_4*8i64)) + ax0_ax1_ax2_fused_2_4), 64i64)))
                      bind(v2_4, floormod((((ax0_ax1_ax2_fused_0_4*256i64) + (ax0_ax1_ax2_fused_1_4*8i64)) + ax0_ax1_ax2_fused_2_4), 64i64))
