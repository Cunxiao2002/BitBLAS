#[version = "0.0.5"]
@main = primfn(input0_handle: handle, param_0_handle: handle, T_relu_intermediate_handle: handle) -> ()
  attr = {"tir.noalias": True, "global_symbol": "fused_dense_relu", "dlight.tensorcore_prenormlized": True}
  ...
  block([], "root") {
    tir.reads([])
    tir.writes([])
    input0_reindex_shared.dyn = alloc_buffer(float16[1i64, 2073600i64, 64i64])
    param_0_reindex_shared.dyn = alloc_buffer(float16[1i64, 64i64, 64i64])
    input0_reindex_shared.dyn_warp = alloc_buffer(float16[1i64, 129600i64, 4i64, 32i64, 8i64])
    param_0_reindex_shared.dyn_warp = alloc_buffer(float16[1i64, 4i64, 4i64, 32i64, 8i64])
    T_matmul_NT_intermediate_reindex_shared.dyn = alloc_buffer(float16[1i64, 2073600i64, 64i64])
    T_matmul_NT_intermediate_reindex_shared.dyn_warp = alloc_buffer(float16[1i64, 129600i64, 4i64, 32i64, 8i64])
              ...
              for (ax1_0_3_init: int64, 0i64, 3i64) {
                for (ax2_0_3_init: int64, 0i64, 2i64) {
                  block([1i64, 129600i64, 4i64], "T_matmul_NT_o_init") as [v0_o, v1_o, v2_o] {
                    ...
                    tir.reads([])
                    tir.writes([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o, v2_o, 0i64:32i64, 0i64:8i64]])
                    block([1i64, 1i64], "T_matmul_NT_init_o") as [v1_i_init_o, v2_i_init_o] {
                      bind(v1_i_init_o, 0i64)
                      bind(v2_i_init_o, 0i64)
                      tir.reads([])
                      tir.writes([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o, v2_o, 0i64:32i64, 0i64:8i64]])
                      C_warp = match_buffer(T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o, v2_o, 0i64:32i64, 0i64:8i64])
                      ...
                      for (ax0_ax1_ax2_fused_3: int64, 0i64, 32i64) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4: int64, 0i64, 8i64) "vectorized" {
                          block([1i64, 2073600i64, 64i64], "input0_reindex_shared.dyn") as [v0, v1, v2] {
                            ...
                            tir.writes([input0_reindex_shared.dyn[v0, v1, v2]])
                            tir.attrs({"permuted_layout": 1})
                            input0_reindex_shared.dyn[v0, v1, v2] = input0[v1, v2]
                        }
                      }
                    }
                  }
                      ...
                      for (ax0_ax1_ax2_fused_3_1: int64, 0i64, 32i64) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_1: int64, 0i64, 8i64) "vectorized" {
                          block([1i64, 64i64, 64i64], "param_0_reindex_shared.dyn") as [v0_1, v1_1, v2_1] {
                            ...
                            tir.writes([param_0_reindex_shared.dyn[v0_1, v1_1, v2_1]])
                            tir.attrs({"permuted_layout": 1})
                            param_0_reindex_shared.dyn[v0_1, v1_1, v2_1] = param_0[v1_1, v2_1]
                        }
                      }
                    }
                  }
                  ...
                  for (ax0_0: int64, 0i64, 3i64) {
                    for (ax1_0: int64, 0i64, 1i64) {
                      block([1i64, 129600i64, 4i64], "input0_reindex_shared.dyn_warp_o") as [v0_o_1, v1_o_1, v2_o_1] {
                        ...
                        tir.reads([input0_reindex_shared.dyn[v0_o_1, (v1_o_1*16i64):((v1_o_1*16i64) + 16i64), (v2_o_1*16i64):((v2_o_1*16i64) + 16i64)]])
                        tir.writes([input0_reindex_shared.dyn_warp[v0_o_1, v1_o_1, v2_o_1, 0i64:32i64, 0i64:8i64]])
                        tir.attrs({"permuted_layout": 1})
                        warp = match_buffer(input0_reindex_shared.dyn_warp[v0_o_1, v1_o_1, v2_o_1, 0i64:32i64, 0i64:8i64])
                        shared = match_buffer(input0_reindex_shared.dyn[v0_o_1, (v1_o_1*16i64):((v1_o_1*16i64) + 16i64), (v2_o_1*16i64):((v2_o_1*16i64) + 16i64)])
                  ...
                  for (ax0_0_1: int64, 0i64, 2i64) {
                    for (ax1_0_1: int64, 0i64, 1i64) {
                      block([1i64, 4i64, 4i64], "param_0_reindex_shared.dyn_warp_o") as [v0_o_2, v1_o_2, v2_o_2] {
                        ...
                        tir.reads([param_0_reindex_shared.dyn[v0_o_2, (v1_o_2*16i64):((v1_o_2*16i64) + 16i64), (v2_o_2*16i64):((v2_o_2*16i64) + 16i64)]])
                        tir.writes([param_0_reindex_shared.dyn_warp[v0_o_2, v1_o_2, v2_o_2, 0i64:32i64, 0i64:8i64]])
                        tir.attrs({"permuted_layout": 1})
                        warp_2 = match_buffer(param_0_reindex_shared.dyn_warp[v0_o_2, v1_o_2, v2_o_2, 0i64:32i64, 0i64:8i64])
                        shared_2 = match_buffer(param_0_reindex_shared.dyn[v0_o_2, (v1_o_2*16i64):((v1_o_2*16i64) + 16i64), (v2_o_2*16i64):((v2_o_2*16i64) + 16i64)])
                  ...
                  for (ax1_0_3: int64, 0i64, 3i64) {
                    for (ax2_0_3: int64, 0i64, 2i64) {
                      block([1i64, 129600i64, 4i64, tir.reduce_axis(0i64, 4i64)], "T_matmul_NT_o_update") as [v0_o_3, v1_o_3, v2_o_3, v3_o] {
                        ...
                        tir.reads([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o_3, v2_o_3, 0i64:32i64, 0i64:8i64], input0_reindex_shared.dyn_warp[0i64, v1_o_3, v3_o, 0i64:32i64, 0i64:8i64], param_0_reindex_shared.dyn_warp[0i64, v2_o_3, v3_o, 0i64:32i64, 0i64:8i64]])
                        tir.writes([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o_3, v2_o_3, 0i64:32i64, 0i64:8i64]])
                        block([1i64, 1i64, tir.reduce_axis(0i64, 1i64)], "T_matmul_NT_o") as [v1_i_o, v2_i_o, v3_i_o] {
                          ...
                          tir.reads([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o_3, v2_o_3, 0i64:32i64, 0i64:8i64], input0_reindex_shared.dyn_warp[0i64, v1_o_3, v3_o, 0i64:32i64, 0i64:8i64], param_0_reindex_shared.dyn_warp[0i64, v2_o_3, v3_o, 0i64:32i64, 0i64:8i64]])
                          tir.writes([T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o_3, v2_o_3, 0i64:32i64, 0i64:8i64]])
                          A = match_buffer(input0_reindex_shared.dyn_warp[0i64, v1_o_3, v3_o, 0i64:32i64, 0i64:8i64])
                          B = match_buffer(param_0_reindex_shared.dyn_warp[0i64, v2_o_3, v3_o, 0i64:32i64, 0i64:8i64])
                          C = match_buffer(T_matmul_NT_intermediate_reindex_shared.dyn_warp[0i64, v1_o_3, v2_o_3, 0i64:32i64, 0i64:8i64])
              ...
              for (ax0_0_2: int64, 0i64, 3i64) {
                for (ax1_0_4: int64, 0i64, 2i64) {
                  block([1i64, 129600i64, 4i64], "T_matmul_NT_intermediate_reindex_shared.dyn_warp_o") as [v0_o_4, v1_o_4, v2_o_4] {
                    ...
                    tir.reads([T_matmul_NT_intermediate_reindex_shared.dyn_warp[v0_o_4, v1_o_4, v2_o_4, 0i64:32i64, 0i64:8i64]])
                    tir.writes([T_matmul_NT_intermediate_reindex_shared.dyn[v0_o_4, (v1_o_4*16i64):((v1_o_4*16i64) + 16i64), (v2_o_4*16i64):((v2_o_4*16i64) + 16i64)]])
                    C_warp_2 = match_buffer(T_matmul_NT_intermediate_reindex_shared.dyn_warp[v0_o_4, v1_o_4, v2_o_4, 0i64:32i64, 0i64:8i64])
                    C_2 = match_buffer(T_matmul_NT_intermediate_reindex_shared.dyn[v0_o_4, (v1_o_4*16i64):((v1_o_4*16i64) + 16i64), (v2_o_4*16i64):((v2_o_4*16i64) + 16i64)])
              ...
              for (ax0_ax1_ax2_fused_1_2: int64, 0i64, 32i64) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_2: int64, 0i64, 8i64) "vectorized" {
                  block([1i64, 2073600i64, 64i64], "T_matmul_NT_intermediate_reindex_shared.dyn") as [v0_2, v1_2, v2_2] {
                    ...
                    tir.reads([T_matmul_NT_intermediate_reindex_shared.dyn[v0_2, v1_2, v2_2]])
                    tir.writes([T_relu_intermediate[v1_2, v2_2]])
                    T_relu_intermediate[v1_2, v2_2] = max(T_matmul_NT_intermediate_reindex_shared.dyn[v0_2, v1_2, v2_2], 0f16)
                }
              }
            }
          }
