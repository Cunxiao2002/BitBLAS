...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  buffers = {A: Buffer(A_1: Pointer(global float16), float16, [512, 128], []),
             B: Buffer(B_1: Pointer(global float16), float16, [128, 128], []),
  ...
  block([], "root") {
    ...
    B_reindex_shared.dyn = alloc_buffer(float16[1, 128, 128])
    A_reindex_shared.dyn_warp = alloc_buffer(float16[1, 32, 8, 32, 8])
    B_reindex_shared.dyn_warp = alloc_buffer(float16[1, 8, 8, 32, 8])
                    ...
                    for (ax0_ax1_ax2_fused_2_1: int32, 0, 16) "unroll" {
                      for (ax0_ax1_ax2_fused_3_1: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_1: int32, 0, 8) "vectorized" {
                          block([1, 128, 128], "B_reindex_shared.dyn") as [v0_1, v1_1, v2_1] {
                            bind(v0_1, 0)
                            bind(v1_1, floordiv((((((ax0_ax1_ax2_fused_0_1*16384) + (ax0_ax1_ax2_fused_1_1*4096)) + (ax0_ax1_ax2_fused_2_1*256)) + (ax0_ax1_ax2_fused_3_1*8)) + ax0_ax1_ax2_fused_4_1), 128))
                ...
                for (ax3_0_1: int32, 0, 8) {
                  ...
                  for (ax0_0_1: int32, 0, 1) {
                    for (ax1_0_1: int32, 0, 2) {
                      block([1, 8, 8], "B_reindex_shared.dyn_warp_o") as [v0_o_2, v1_o_2, v2_o_2] {
                        bind(v0_o_2, 0)
                  ...
                  for (ax1_0_3: int32, 0, 1) {
                    for (ax2_0_3: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 8)], "gemm_o_update") as [v0_o_3, v1_o_3, v2_o_3, v3_o] {
                        bind(v0_o_3, ax0)
