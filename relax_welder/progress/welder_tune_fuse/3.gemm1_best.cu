...
@main = primfn(a: handle, b: handle, c: handle) -> ()
  ...
  buffers = {A: Buffer(A_1: Pointer(global float16), float16, [512, 512], []),
             B: Buffer(B_1: Pointer(global float16), float16, [512, 128], []),
             C: Buffer(C_1: Pointer(global float16), float16, [512, 128], [])}
  buffer_map = {a: A, b: B, c: C} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
    A_reindex_shared.dyn = alloc_buffer(float16[1, 512, 512])
    B_reindex_shared.dyn = alloc_buffer(float16[1, 512, 128])
    A_reindex_shared.dyn_warp = alloc_buffer(float16[1, 32, 32, 32, 8])
    B_reindex_shared.dyn_warp = alloc_buffer(float16[1, 32, 8, 32, 8])
    C_reindex_shared.dyn = alloc_buffer(float16[1, 512, 128])
    C_reindex_shared.dyn_warp = alloc_buffer(float16[1, 32, 8, 32, 8])
          ...
          for (ax1_0_2: int32, 0, 1) "thread_binding" {
            for (ax2_0_2: int32, 0, 4) "thread_binding" {
              for (ax1_0_3_init: int32, 0, 1) {
                for (ax2_0_3_init: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init") as [v0_o, v1_o, v2_o] {
                    bind(v0_o, ax0)
                    bind(v1_o, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3_init))
                    bind(v2_o, ((ax2_0_2*2) + ax2_0_3_init))
                    tir.reads([])
              ...
              for (ax3_0_0: int32, 0, 4) {
                    ...
                    for (ax0_ax1_ax2_fused_2: int32, 0, 2) "unroll" {
                      for (ax0_ax1_ax2_fused_3: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4: int32, 0, 8) "vectorized" {
                          block([1, 512, 512], "A_reindex_shared.dyn") as [v0, v1, v2] {
                            bind(v0, 0)
                            ...
                            bind(v2, ((ax3_0_0*128) + floormod((((((ax0_ax1_ax2_fused_0*2048) + (ax0_ax1_ax2_fused_1*512)) + (ax0_ax1_ax2_fused_2*256)) + (ax0_ax1_ax2_fused_3*8)) + ax0_ax1_ax2_fused_4), 128)))
                            tir.reads([A[v1, v2]])
                ...
                for (ax0_ax1_ax2_fused_0_1: int32, 0, 1) "thread_binding" {
                  for (ax0_ax1_ax2_fused_1_1: int32, 0, 4) "thread_binding" {
                    for (ax0_ax1_ax2_fused_2_1: int32, 0, 16) "unroll" {
                      for (ax0_ax1_ax2_fused_3_1: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_1: int32, 0, 8) "vectorized" {
                          block([1, 512, 128], "B_reindex_shared.dyn") as [v0_1, v1_1, v2_1] {
                            bind(v0_1, 0)
                            bind(v1_1, ((ax3_0_0*128) + floordiv((((((ax0_ax1_ax2_fused_0_1*16384) + (ax0_ax1_ax2_fused_1_1*4096)) + (ax0_ax1_ax2_fused_2_1*256)) + (ax0_ax1_ax2_fused_3_1*8)) + ax0_ax1_ax2_fused_4_1), 128)))
                            bind(v2_1, floormod((((((ax0_ax1_ax2_fused_0_1*16384) + (ax0_ax1_ax2_fused_1_1*4096)) + (ax0_ax1_ax2_fused_2_1*256)) + (ax0_ax1_ax2_fused_3_1*8)) + ax0_ax1_ax2_fused_4_1), 128))
                ...
                for (ax3_0_1: int32, 0, 8) {
                  for (ax0_0: int32, 0, 1) {
                    for (ax1_0: int32, 0, 1) {
                      block([1, 32, 32], "A_reindex_shared.dyn_warp_o") as [v0_o_1, v1_o_1, v2_o_1] {
                        bind(v0_o_1, 0)
                        bind(v1_o_1, (ax1_0_0_ax2_0_0_fused + ax0_0))
                        bind(v2_o_1, (((ax3_0_0*8) + ax3_0_1) + ax1_0))
                  ...
                  for (ax0_0_1: int32, 0, 1) {
                    for (ax1_0_1: int32, 0, 2) {
                      block([1, 32, 8], "B_reindex_shared.dyn_warp_o") as [v0_o_2, v1_o_2, v2_o_2] {
                        bind(v0_o_2, 0)
                        bind(v1_o_2, (((ax3_0_0*8) + ax3_0_1) + ax0_0_1))
                        bind(v2_o_2, ((ax2_0_2*2) + ax1_0_1))
                  ...
                  for (ax1_0_3: int32, 0, 1) {
                    for (ax2_0_3: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 32)], "gemm_o_update") as [v0_o_3, v1_o_3, v2_o_3, v3_o] {
                        bind(v0_o_3, ax0)
                        bind(v1_o_3, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3))
                        bind(v2_o_3, ((ax2_0_2*2) + ax2_0_3))
              ...
              for (ax0_0_2: int32, 0, 1) {
                for (ax1_0_4: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o") as [v0_o_4, v1_o_4, v2_o_4] {
                    bind(v0_o_4, 0)
                    bind(v1_o_4, ax1_0_0_ax2_0_0_fused)
                    bind(v2_o_4, ((ax2_0_2*2) + ax1_0_4))
            ...
            for (ax0_ax1_ax2_fused_0_2: int32, 0, 8) "unroll" {
              for (ax0_ax1_ax2_fused_1_2: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_2: int32, 0, 8) "vectorized" {
                  block([1, 512, 128], "C_reindex_shared.dyn") as [v0_2, v1_2, v2_2] {
                    bind(v0_2, 0)
                    bind(v1_2, ((ax1_0_0_ax2_0_0_fused*16) + floordiv((((ax0_ax1_ax2_fused_0_2*256) + (ax0_ax1_ax2_fused_1_2*8)) + ax0_ax1_ax2_fused_2_2), 128)))
                    bind(v2_2, floormod((((ax0_ax1_ax2_fused_0_2*256) + (ax0_ax1_ax2_fused_1_2*8)) + ax0_ax1_ax2_fused_2_2), 128))
