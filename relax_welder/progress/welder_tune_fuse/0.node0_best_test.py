...
@T.prim_func
def gemm(A: T.Buffer((512, 128), "float16"), B: T.Buffer((128, 512), "float16"), C: T.Buffer((512, 512), "float16")):
    ...
    C_reindex_shared_dyn = T.alloc_buffer((1, 32, 32, 16, 16), "float16", scope="shared.dyn")
    C_reindex_shared_dyn_warp = T.alloc_buffer((1, 32, 32, 32, 8), "float16", scope="warp")
    for ax0 in T.thread_binding(1, thread="blockIdx.z"):
        for ax1_0_0_ax2_0_0_fused in T.thread_binding(16, thread="blockIdx.y"):
            for ax1_0_1_ax2_0_1_fused in T.thread_binding(1, thread="blockIdx.x"):
                for ax1_0_2 in T.thread_binding(2, thread="threadIdx.y"):
                    for ax2_0_2 in T.thread_binding(2, thread="threadIdx.z"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(1, 16):
                            with T.block("gemm_o_init"):
                                v0_o = T.axis.spatial(1, ax0)
                                v1_o = T.axis.spatial(32, ax1_0_0_ax2_0_0_fused * 2 + ax1_0_2 + ax1_0_3_init)
                                v2_o = T.axis.spatial(32, ax2_0_2 * 16 + ax2_0_3_init)
                                T.reads()
                        ...
                        for ax3_0_0 in range(1):
                            for ax0_ax1_ax2_fused_0 in T.thread_binding(2, thread="threadIdx.y"):
                                for ax0_ax1_ax2_fused_1 in T.thread_binding(2, thread="threadIdx.z"):
                                    for ax0_ax1_ax2_fused_2 in T.unroll(4, annotations={"pragma_unroll_explicit": 0}):
                                        for ax0_ax1_ax2_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_4 in T.vectorized(8):
                                                with T.block("A_reindex_shared.dyn"):
                                                    ...
                                                    v1 = T.axis.spatial(512, ax1_0_0_ax2_0_0_fused * 32 + (ax0_ax1_ax2_fused_0 * 2048 + ax0_ax1_ax2_fused_1 * 1024 + ax0_ax1_ax2_fused_2 * 256 + ax0_ax1_ax2_fused_3 * 8 + ax0_ax1_ax2_fused_4) // 128)
                                                    v2 = T.axis.spatial(128, (ax0_ax1_ax2_fused_0 * 2048 + ax0_ax1_ax2_fused_1 * 1024 + ax0_ax1_ax2_fused_2 * 256 + ax0_ax1_ax2_fused_3 * 8 + ax0_ax1_ax2_fused_4) % 128)
                                                    T.reads(A[v1, v2])
                                        ...
                                        for ax0_ax1_ax2_fused_3 in T.thread_binding(32, thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_4 in T.vectorized(8):
                                                with T.block("B_reindex_shared.dyn"):
                                                    v0 = T.axis.spatial(1, 0)
                                                    v1 = T.axis.spatial(128, (ax0_ax1_ax2_fused_0 * 32768 + ax0_ax1_ax2_fused_1 * 16384 + ax0_ax1_ax2_fused_2 * 256 + ax0_ax1_ax2_fused_3 * 8 + ax0_ax1_ax2_fused_4) // 512)
                                                    v2 = T.axis.spatial(512, (ax0_ax1_ax2_fused_0 * 32768 + ax0_ax1_ax2_fused_1 * 16384 + ax0_ax1_ax2_fused_2 * 256 + ax0_ax1_ax2_fused_3 * 8 + ax0_ax1_ax2_fused_4) % 512)
                                                    T.reads(B[v1, v2])
                            ...
                            for ax3_0_1 in range(8):
                                for ax0_0, ax1_0 in T.grid(1, 1):
                                    with T.block("A_reindex_shared.dyn_warp_o"):
                                        ...
                                        v1_o = T.axis.spatial(32, ax1_0_0_ax2_0_0_fused * 2 + ax1_0_2 + ax0_0)
                                ...
                                for ax0_0, ax1_0 in T.grid(1, 16):
                                    with T.block("B_reindex_shared.dyn_warp_o"):
                                        ...
                                        v2_o = T.axis.spatial(32, ax2_0_2 * 16 + ax1_0)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(1, 16):
                                    with T.block("gemm_o_update"):
                                        v0_o = T.axis.spatial(1, ax0)
                                        v1_o = T.axis.spatial(32, ax1_0_0_ax2_0_0_fused * 2 + ax1_0_2 + ax1_0_3)
                                        v2_o = T.axis.spatial(32, ax2_0_2 * 16 + ax2_0_3)
                        ...
                        for ax0_1, ax1_0, ax2_0 in T.grid(16, 1, 1):
                            with T.block("C_reindex_shared.dyn_warp_o"):
                                v0_o = T.axis.spatial(1, 0)
                                v1_o = T.axis.spatial(32, ax1_0_0_ax2_0_0_fused * 2 + ax1_0_2)
                                v2_o = T.axis.spatial(32, ax2_0_2 * 16 + ax0_1)
                                v3_o = T.axis.spatial(1, 0)
                                v4_o = T.axis.spatial(1, 0)
                                T.reads(C_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, 0:32, 0:8])
                                T.writes(C_reindex_shared_dyn[v0_o, v1_o, v2_o, 0:16, 0:16])
                                C_warp = T.match_buffer(C_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, 0:32, 0:8], (32, 8), "float16", scope="warp", offset_factor=1)
                                C_1 = T.match_buffer(C_reindex_shared_dyn[v0_o, v1_o, v2_o, 0:16, 0:16], (16, 16), "float16", strides=("C_s0", "C_s1"), scope="shared.dyn", offset_factor=1)
                                for tx in T.thread_binding(32, thread="threadIdx.x"):
                        ...
                        for ax0_ax1_ax2_ax3_ax4_fused_0 in T.unroll(16, annotations={"pragma_unroll_explicit": 0}):
                            for ax0_ax1_ax2_ax3_ax4_fused_1 in T.thread_binding(32, thread="threadIdx.x"):
                                for ax0_ax1_ax2_ax3_ax4_fused_2 in T.vectorized(8):
                                    with T.block("C_reindex_shared.dyn"):
                                        v0 = T.axis.spatial(1, 0)
                                        v1 = T.axis.spatial(32, ax1_0_0_ax2_0_0_fused * 2 + ax1_0_2)
                                        v2 = T.axis.spatial(32, ax2_0_2 * 16 + (ax0_ax1_ax2_ax3_ax4_fused_0 * 256 + ax0_ax1_ax2_ax3_ax4_fused_1 * 8 + ax0_ax1_ax2_ax3_ax4_fused_2) // 256)
                                        v3 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_ax4_fused_0 * 256 + ax0_ax1_ax2_ax3_ax4_fused_1 * 8 + ax0_ax1_ax2_ax3_ax4_fused_2) % 256 // 16)
                                        v4 = T.axis.spatial(16, (ax0_ax1_ax2_ax3_ax4_fused_0 * 256 + ax0_ax1_ax2_ax3_ax4_fused_1 * 8 + ax0_ax1_ax2_ax3_ax4_fused_2) % 16)
                                        T.reads(C_reindex_shared_dyn[v0, v1, v2, v3, v4])
                                        T.writes(C[v3 + v1 * 16, v4 + v2 * 16])
                                        C[v3 + v1 * 16, v4 + v2 * 16] = C_reindex_shared_dyn[v0, v1, v2, v3, v4]