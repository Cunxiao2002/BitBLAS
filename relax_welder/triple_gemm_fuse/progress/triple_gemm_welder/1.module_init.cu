...
@gemm_0 = primfn(A_handle: handle, B_handle: handle, C_handle: handle) -> ()
  attr = {"dlight.tensorcore_prenormlized": True, "global_symbol": "gemm_0"}
                    ...
                    for (ax2_0_3: int32, 0, 8) {
                      block([1, 32, 32, tir.reduce_axis(0, 8)], "gemm_o_update") as [v0_o_3, v1_o_3, v2_o_3, v3_o] {
                        ...
                        block([1, 1, tir.reduce_axis(0, 1)], "gemm_o") as [v1_i_o, v2_i_o, v3_i_o] {
                          ...
                          C_1_1 = match_buffer(C_reindex_shared_dyn_warp[0, v1_o_3, v2_o_3, 0:32, 0:8])
                          for (tx_3: int32, 0, 32) "thread_binding" {
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_2: Pointer(warp float16), (elem_offset_5: int32 + (tx_3*8)), B_1_2: Pointer(warp float16), (elem_offset_6: int32 + (tx_3*8)), C_1_2: Pointer(warp float16), (elem_offset_7: int32 + (tx_3*8)), False, dtype=float16)
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_2, (elem_offset_5 + (tx_3*8)), B_1_2, ((elem_offset_6 + (tx_3*8)) + 4), C_1_2, ((elem_offset_7 + (tx_3*8)) + 4), False, dtype=float16)
                          }
                    }
                  }
                }
              ...
              for (ax0_0_2: int32, 0, 1) {
                for (ax1_0_4: int32, 0, 8) {
                  block([1, 32, 32], "C_reindex_shared.dyn_warp_o") as [v0_o_4, v1_o_4, v2_o_4] {
                    ...
                    C_1_3 = match_buffer(C_reindex_shared_dyn[v0_o_4, (v1_o_4*16):((v1_o_4*16) + 16), (v2_o_4*16):((v2_o_4*16) + 16)])
                    for (tx_4: int32, 0, 32) "thread_binding" {
                      @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_1_4: Pointer(shared.dyn float16), elem_offset_8: int32, (C_1_s0: int32*16), 2, dtype=handle), C_warp_3: Pointer(warp float16), elem_offset_9: int32, C_1_s0, dtype=float16)
                    }
                }
              }
            }
              ...
              for (ax0_ax1_ax2_fused_1_2: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_2: int32, 0, 8) "vectorized" {
                  block([1, 512, 512], "C_reindex_shared.dyn") as [v0_2, v1_2, v2_2] {
                    ...
                    C[v1_2, v2_2] = C_reindex_shared_dyn[v0_2, v1_2, v2_2]
                }
              }
            }
          }
...
@gemm_1 = primfn(A_handle_1: handle, B_handle_1: handle, C_handle_1: handle) -> ()
  attr = {"dlight.tensorcore_prenormlized": True, "global_symbol": "gemm_1"}
  buffers = {A_2: Buffer(A_3: Pointer(global float16), float16, [512, 512], []),
             B_2: Buffer(B_3: Pointer(global float16), float16, [512, 128], []),
             C_2: Buffer(C_3: Pointer(global float16), float16, [512, 128], [])}
  buffer_map = {A_handle_1: A_2, B_handle_1: B_2, C_handle_1: C_2} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
            ...
            for (ax2_0_2_1: int32, 0, 4) "thread_binding" {
              for (ax1_0_3_init_1: int32, 0, 1) {
                for (ax2_0_3_init_1: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init") as [v0_o_5, v1_o_5, v2_o_5] {
                    bind(v0_o_5, ax0_1)
                    ...
                    block([1, 1], "gemm_init_o") as [v1_i_init_o_1, v2_i_init_o_1] {
                    ...
                    for (ax0_ax1_ax2_fused_2_3: int32, 0, 2) "unroll" {
                      for (ax0_ax1_ax2_fused_3_2: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_2: int32, 0, 8) "vectorized" {
                          block([1, 512, 512], "A_reindex_shared.dyn") as [v0_3, v1_3, v2_3] {
                            bind(v0_3, 0)
                            ...
                            tir.reads([A_2[v1_3, v2_3]])
                            tir.writes([A_reindex_shared_dyn_1[v0_3, v1_3, v2_3]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            A_reindex_shared_dyn_1[v0_3, v1_3, v2_3] = A_2[v1_3, v2_3]
                        }
                      }
                    }
                  }
                    ...
                    for (ax0_ax1_ax2_fused_2_4: int32, 0, 16) "unroll" {
                      for (ax0_ax1_ax2_fused_3_3: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_3: int32, 0, 8) "vectorized" {
                          block([1, 512, 128], "B_reindex_shared.dyn") as [v0_4, v1_4, v2_4] {
                            bind(v0_4, 0)
                            ...
                            tir.reads([B_2[v1_4, v2_4]])
                            tir.writes([B_reindex_shared_dyn_1[v0_4, v1_4, v2_4]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            B_reindex_shared_dyn_1[v0_4, v1_4, v2_4] = B_2[v1_4, v2_4]
                        }
                      }
                    }
                  }
                ...
                for (ax3_0_1_1: int32, 0, 8) {
                  for (ax0_0_3: int32, 0, 1) {
                    for (ax1_0_5: int32, 0, 1) {
                      block([1, 32, 32], "A_reindex_shared.dyn_warp_o") as [v0_o_6, v1_o_6, v2_o_6] {
                        bind(v0_o_6, 0)
                  ...
                  for (ax0_0_4: int32, 0, 1) {
                    for (ax1_0_6: int32, 0, 2) {
                      block([1, 32, 8], "B_reindex_shared.dyn_warp_o") as [v0_o_7, v1_o_7, v2_o_7] {
                        bind(v0_o_7, 0)
                  ...
                  for (ax1_0_3_1: int32, 0, 1) {
                    for (ax2_0_3_1: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 32)], "gemm_o_update") as [v0_o_8, v1_o_8, v2_o_8, v3_o_1] {
                        bind(v0_o_8, ax0_1)
                        ...
                        block([1, 1, tir.reduce_axis(0, 1)], "gemm_o") as [v1_i_o_1, v2_i_o_1, v3_i_o_1] {
                          bind(v1_i_o_1, 0)
                          bind(v2_i_o_1, 0)
                          bind(v3_i_o_1, 0)
                          tir.reads([C_reindex_shared_dyn_warp_1[0, v1_o_8, v2_o_8, 0:32, 0:8], A_reindex_shared_dyn_warp_1[0, v1_o_8, v3_o_1, 0:32, 0:8], B_reindex_shared_dyn_warp_1[0, v3_o_1, v2_o_8, 0:32, 0:8]])
                          ...
                          C_1_5 = match_buffer(C_reindex_shared_dyn_warp_1[0, v1_o_8, v2_o_8, 0:32, 0:8])
                          for (tx_8: int32, 0, 32) "thread_binding" {
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_4: Pointer(warp float16), (elem_offset_15: int32 + (tx_8*8)), B_1_4: Pointer(warp float16), (elem_offset_16: int32 + (tx_8*8)), C_1_6: Pointer(warp float16), (elem_offset_17: int32 + (tx_8*8)), False, dtype=float16)
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_4, (elem_offset_15 + (tx_8*8)), B_1_4, ((elem_offset_16 + (tx_8*8)) + 4), C_1_6, ((elem_offset_17 + (tx_8*8)) + 4), False, dtype=float16)
                          }
                    }
                  }
                }
              ...
              for (ax0_0_5: int32, 0, 1) {
                for (ax1_0_7: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o") as [v0_o_9, v1_o_9, v2_o_9] {
                    bind(v0_o_9, 0)
                    ...
                    C_1_7 = match_buffer(C_reindex_shared_dyn_1[v0_o_9, (v1_o_9*16):((v1_o_9*16) + 16), (v2_o_9*16):((v2_o_9*16) + 16)])
                    for (tx_9: int32, 0, 32) "thread_binding" {
                      @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_1_8: Pointer(shared.dyn float16), elem_offset_18: int32, (C_1_s0_1: int32*16), 2, dtype=handle), C_warp_7: Pointer(warp float16), elem_offset_19: int32, C_1_s0_1, dtype=float16)
                    }
                }
              }
            }
            for (ax0_ax1_ax2_fused_0_5: int32, 0, 8) "unroll" {
              for (ax0_ax1_ax2_fused_1_5: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_5: int32, 0, 8) "vectorized" {
                  block([1, 512, 128], "C_reindex_shared.dyn") as [v0_5, v1_5, v2_5] {
                    bind(v0_5, 0)
                    ...
                    tir.writes([C_2[v1_5, v2_5]])
                    C_2[v1_5, v2_5] = C_reindex_shared_dyn_1[v0_5, v1_5, v2_5]
                }
              }
            }
          }
...
@gemm_2 = primfn(A_handle_2: handle, B_handle_2: handle, C_handle_2: handle) -> ()
  attr = {"dlight.tensorcore_prenormlized": True, "global_symbol": "gemm_2"}
  buffers = {A_4: Buffer(A_5: Pointer(global float16), float16, [512, 128], []),
             B_4: Buffer(B_5: Pointer(global float16), float16, [128, 128], []),
             C_4: Buffer(C_5: Pointer(global float16), float16, [512, 128], [])}
  buffer_map = {A_handle_2: A_4, B_handle_2: B_4, C_handle_2: C_4} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
            ...
            for (ax2_0_2_2: int32, 0, 4) "thread_binding" {
              for (ax1_0_3_init_2: int32, 0, 1) {
                for (ax2_0_3_init_2: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init") as [v0_o_10, v1_o_10, v2_o_10] {
                    bind(v0_o_10, ax0_2)
                    ...
                    block([1, 1], "gemm_init_o") as [v1_i_init_o_2, v2_i_init_o_2] {
                    ...
                    for (ax0_ax1_ax2_fused_2_6: int32, 0, 2) "unroll" {
                      for (ax0_ax1_ax2_fused_3_4: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_4: int32, 0, 8) "vectorized" {
                          block([1, 512, 128], "A_reindex_shared.dyn") as [v0_6, v1_6, v2_6] {
                            bind(v0_6, 0)
                            ...
                            tir.reads([A_4[v1_6, v2_6]])
                            tir.writes([A_reindex_shared_dyn_2[v0_6, v1_6, v2_6]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            A_reindex_shared_dyn_2[v0_6, v1_6, v2_6] = A_4[v1_6, v2_6]
                        }
                      }
                    }
                  }
                    ...
                    for (ax0_ax1_ax2_fused_2_7: int32, 0, 16) "unroll" {
                      for (ax0_ax1_ax2_fused_3_5: int32, 0, 32) "thread_binding" {
                        for (ax0_ax1_ax2_fused_4_5: int32, 0, 8) "vectorized" {
                          block([1, 128, 128], "B_reindex_shared.dyn") as [v0_7, v1_7, v2_7] {
                            bind(v0_7, 0)
                            ...
                            tir.reads([B_4[v1_7, v2_7]])
                            tir.writes([B_reindex_shared_dyn_2[v0_7, v1_7, v2_7]])
                            tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                            B_reindex_shared_dyn_2[v0_7, v1_7, v2_7] = B_4[v1_7, v2_7]
                        }
                      }
                    }
                  }
                ...
                for (ax3_0_1_2: int32, 0, 8) {
                  for (ax0_0_6: int32, 0, 1) {
                    for (ax1_0_8: int32, 0, 1) {
                      block([1, 32, 8], "A_reindex_shared.dyn_warp_o") as [v0_o_11, v1_o_11, v2_o_11] {
                        bind(v0_o_11, 0)
                  ...
                  for (ax0_0_7: int32, 0, 1) {
                    for (ax1_0_9: int32, 0, 2) {
                      block([1, 8, 8], "B_reindex_shared.dyn_warp_o") as [v0_o_12, v1_o_12, v2_o_12] {
                        bind(v0_o_12, 0)
                  ...
                  for (ax1_0_3_2: int32, 0, 1) {
                    for (ax2_0_3_2: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 8)], "gemm_o_update") as [v0_o_13, v1_o_13, v2_o_13, v3_o_2] {
                        bind(v0_o_13, ax0_2)
                        ...
                        block([1, 1, tir.reduce_axis(0, 1)], "gemm_o") as [v1_i_o_2, v2_i_o_2, v3_i_o_2] {
                          bind(v1_i_o_2, 0)
                          bind(v2_i_o_2, 0)
                          bind(v3_i_o_2, 0)
                          tir.reads([C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8], A_reindex_shared_dyn_warp_2[0, v1_o_13, v3_o_2, 0:32, 0:8], B_reindex_shared_dyn_warp_2[0, v3_o_2, v2_o_13, 0:32, 0:8]])
                          ...
                          C_1_9 = match_buffer(C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8])
                          for (tx_13: int32, 0, 32) "thread_binding" {
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_6: Pointer(warp float16), (elem_offset_25: int32 + (tx_13*8)), B_1_6: Pointer(warp float16), (elem_offset_26: int32 + (tx_13*8)), C_1_10: Pointer(warp float16), (elem_offset_27: int32 + (tx_13*8)), False, dtype=float16)
                            @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_6, (elem_offset_25 + (tx_13*8)), B_1_6, ((elem_offset_26 + (tx_13*8)) + 4), C_1_10, ((elem_offset_27 + (tx_13*8)) + 4), False, dtype=float16)
                          }
                    }
                  }
                }
              ...
              for (ax0_0_8: int32, 0, 1) {
                for (ax1_0_10: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o") as [v0_o_14, v1_o_14, v2_o_14] {
                    bind(v0_o_14, 0)
                    ...
                    C_1_11 = match_buffer(C_reindex_shared_dyn_2[v0_o_14, (v1_o_14*16):((v1_o_14*16) + 16), (v2_o_14*16):((v2_o_14*16) + 16)])
                    for (tx_14: int32, 0, 32) "thread_binding" {
                      @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_1_12: Pointer(shared.dyn float16), elem_offset_28: int32, (C_1_s0_2: int32*16), 2, dtype=handle), C_warp_11: Pointer(warp float16), elem_offset_29: int32, C_1_s0_2, dtype=float16)
                    }
                }
              }
            }
            for (ax0_ax1_ax2_fused_0_8: int32, 0, 8) "unroll" {
              for (ax0_ax1_ax2_fused_1_8: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_8: int32, 0, 8) "vectorized" {
                  block([1, 512, 128], "C_reindex_shared.dyn") as [v0_8, v1_8, v2_8] {
                    bind(v0_8, 0)
                    ...
                    tir.writes([C_4[v1_8, v2_8]])
                    C_4[v1_8, v2_8] = C_reindex_shared_dyn_2[v0_8, v1_8, v2_8]
                }
              }
            }
          }
