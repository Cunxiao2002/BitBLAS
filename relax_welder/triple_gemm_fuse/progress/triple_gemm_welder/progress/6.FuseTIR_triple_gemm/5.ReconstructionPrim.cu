#[version = "0.0.5"]
@fused_gemm_0_gemm_1_gemm_2 = primfn(A_handle: handle, B_handle: handle, D_handle: handle, F_handle: handle, C_intermediate_1_2_handle: handle) -> ()
  ...
  buffers = {A: Buffer(A_1: Pointer(global float16), float16, [512i64, 128i64], []),
             ...
             F: Buffer(F_1: Pointer(global float16), float16, [128i64, 128i64], []),
             C_intermediate_1_2: Buffer(C_intermediate_1_2_1: Pointer(global float16), float16, [512i64, 128i64], [])}
  buffer_map = {A_handle: A, B_handle: B, D_handle: D, F_handle: F, C_intermediate_1_2_handle: C_intermediate_1_2} {
  block([], "root") {
    tir.reads([])
    tir.writes([])
    ...
    C_reindex_shared_dyn_warp_2 = alloc_buffer(float16[1, 32, 8, 32, 8])
     {
        ...
        for (ax1_0_0_ax2_0_0_fused: int32, 0, 32) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused: int32, 0, 1) "thread_binding" {
            for (ax1_0_2: int32, 0, 1) "thread_binding" {
                ...
                for (ax3_0_0_1: int32, 0, 4) {
                  for (ax0_ax1_ax2_fused_0_2: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_2: int32, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_2: int32, 0, 2) "unroll" {
                        for (ax0_ax1_ax2_fused_3_2: int32, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2: int32, 0, 8) "vectorized" {
                            block([1, 512, 512], "A_reindex_shared.dyn_1") as [v0_2, v1_2, v2_2] {
                              bind(v0_2, 0)
                              bind(v1_2, ((ax1_0_0_ax2_0_0_fused_1*16) + floordiv((((((ax0_ax1_ax2_fused_0_2*2048) + (ax0_ax1_ax2_fused_1_2*512)) + (ax0_ax1_ax2_fused_2_2*256)) + (ax0_ax1_ax2_fused_3_2*8)) + ax0_ax1_ax2_fused_4_2), 128)))
                              bind(v2_2, ((ax3_0_0_1*128) + floormod((((((ax0_ax1_ax2_fused_0_2*2048) + (ax0_ax1_ax2_fused_1_2*512)) + (ax0_ax1_ax2_fused_2_2*256)) + (ax0_ax1_ax2_fused_3_2*8)) + ax0_ax1_ax2_fused_4_2), 128)))
                              tir.reads([C_intermediate[v1_2, v2_2]])
                              tir.writes([A_reindex_shared_dyn_1[v0_2, v1_2, v2_2]])
                              tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                              A_reindex_shared_dyn_1[v0_2, v1_2, v2_2] = C_intermediate[v1_2, v2_2]
                          }
                        }
                      }
                    }
                  ...
                  for (ax0_ax1_ax2_fused_0_3: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_3: int32, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_3: int32, 0, 16) "unroll" {
                        for (ax0_ax1_ax2_fused_3_3: int32, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3: int32, 0, 8) "vectorized" {
                            block([1, 512, 128], "B_reindex_shared.dyn_1") as [v0_3, v1_3, v2_3] {
                              bind(v0_3, 0)
                              bind(v1_3, ((ax3_0_0_1*128) + floordiv((((((ax0_ax1_ax2_fused_0_3*16384) + (ax0_ax1_ax2_fused_1_3*4096)) + (ax0_ax1_ax2_fused_2_3*256)) + (ax0_ax1_ax2_fused_3_3*8)) + ax0_ax1_ax2_fused_4_3), 128)))
                              bind(v2_3, floormod((((((ax0_ax1_ax2_fused_0_3*16384) + (ax0_ax1_ax2_fused_1_3*4096)) + (ax0_ax1_ax2_fused_2_3*256)) + (ax0_ax1_ax2_fused_3_3*8)) + ax0_ax1_ax2_fused_4_3), 128))
                              tir.reads([D[v1_3, v2_3]])
                              tir.writes([B_reindex_shared_dyn_1[v0_3, v1_3, v2_3]])
                              tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                              B_reindex_shared_dyn_1[v0_3, v1_3, v2_3] = D[v1_3, v2_3]
                          }
                        }
                      }
                    }
                ...
                for (ax1_0_3_init_2: int32, 0, 1) {
                  for (ax2_0_3_init_2: int32, 0, 2) {
                    block([1, 32, 8], "gemm_o_init_2") as [v0_o_10, v1_o_10, v2_o_10] {
                      bind(v0_o_10, ax0_2: int32)
                      bind(v1_o_10, ((ax1_0_0_ax2_0_0_fused_2: int32 + ax1_0_2_2: int32) + ax1_0_3_init_2))
                      bind(v2_o_10, ((ax2_0_2_2: int32*2) + ax2_0_3_init_2))
                      tir.reads([])
                ...
                for (ax3_0_0_2: int32, 0, 1) {
                  for (ax0_ax1_ax2_fused_0_4: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_4: int32, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_4: int32, 0, 2) "unroll" {
                        for (ax0_ax1_ax2_fused_3_4: int32, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_4: int32, 0, 8) "vectorized" {
                            block([1, 512, 128], "A_reindex_shared.dyn_2") as [v0_4, v1_4, v2_4] {
                              bind(v0_4, 0)
                              bind(v1_4, ((ax1_0_0_ax2_0_0_fused_2*16) + floordiv((((((ax0_ax1_ax2_fused_0_4*2048) + (ax0_ax1_ax2_fused_1_4*512)) + (ax0_ax1_ax2_fused_2_4*256)) + (ax0_ax1_ax2_fused_3_4*8)) + ax0_ax1_ax2_fused_4_4), 128)))
                              bind(v2_4, floormod((((((ax0_ax1_ax2_fused_0_4*2048) + (ax0_ax1_ax2_fused_1_4*512)) + (ax0_ax1_ax2_fused_2_4*256)) + (ax0_ax1_ax2_fused_3_4*8)) + ax0_ax1_ax2_fused_4_4), 128))
                              tir.reads([C_intermediate_1[v1_4, v2_4]])
                              tir.writes([A_reindex_shared_dyn_2[v0_4, v1_4, v2_4]])
                              tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                              A_reindex_shared_dyn_2[v0_4, v1_4, v2_4] = C_intermediate_1[v1_4, v2_4]
                          }
                        }
                      }
                    }
                  }
                  for (ax0_ax1_ax2_fused_0_5: int32, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_5: int32, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_5: int32, 0, 16) "unroll" {
                        for (ax0_ax1_ax2_fused_3_5: int32, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_5: int32, 0, 8) "vectorized" {
                            block([1, 128, 128], "B_reindex_shared.dyn_2") as [v0_5, v1_5, v2_5] {
                              bind(v0_5, 0)
                              bind(v1_5, floordiv((((((ax0_ax1_ax2_fused_0_5*16384) + (ax0_ax1_ax2_fused_1_5*4096)) + (ax0_ax1_ax2_fused_2_5*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 128))
                              bind(v2_5, floormod((((((ax0_ax1_ax2_fused_0_5*16384) + (ax0_ax1_ax2_fused_1_5*4096)) + (ax0_ax1_ax2_fused_2_5*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 128))
                              tir.reads([F[v1_5, v2_5]])
                              tir.writes([B_reindex_shared_dyn_2[v0_5, v1_5, v2_5]])
                              tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                              B_reindex_shared_dyn_2[v0_5, v1_5, v2_5] = F[v1_5, v2_5]
                          }
                        }
                      }
                    }
              ...
              for (ax0_ax1_ax2_fused_0_6: int32, 0, 32) "unroll" {
                for (ax0_ax1_ax2_fused_1_6: int32, 0, 32) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_6: int32, 0, 8) "vectorized" {
                    block([1, 512, 512], "C_reindex_shared.dyn") as [v0_6, v1_6, v2_6] {
                      bind(v0_6, 0)
                      bind(v1_6, ((ax1_0_0_ax2_0_0_fused*16) + floordiv((((ax0_ax1_ax2_fused_0_6*256) + (ax0_ax1_ax2_fused_1_6*8)) + ax0_ax1_ax2_fused_2_6), 512)))
                      bind(v2_6, floormod((((ax0_ax1_ax2_fused_0_6*256) + (ax0_ax1_ax2_fused_1_6*8)) + ax0_ax1_ax2_fused_2_6), 512))
                      tir.reads([C_reindex_shared_dyn[v0_6, v1_6, v2_6]])
                      tir.writes([C_intermediate[v1_6, v2_6]])
                      C_intermediate[v1_6, v2_6] = C_reindex_shared_dyn[v0_6, v1_6, v2_6]
                  }
                }
              }
            }
      ...
      for (ax0_1, 0, 1) "thread_binding" {
        for (ax1_0_0_ax2_0_0_fused_1, 0, 32) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused_1: int32, 0, 1) "thread_binding" {
            for (ax1_0_2_1, 0, 1) "thread_binding" {
              for (ax2_0_2_1, 0, 4) "thread_binding" {
                for (ax1_0_3_init_1, 0, 1) {
                  for (ax2_0_3_init_1, 0, 2) {
                    block([1, 32, 8], "gemm_o_init_1") as [v0_o_5, v1_o_5, v2_o_5] {
                      bind(v0_o_5, ax0_1)
                      ...
                      block([1, 1], "gemm_init_o_1") as [v1_i_init_o_1, v2_i_init_o_1] {
                        ...
                        tir.writes([C_reindex_shared_dyn_warp_1[0, v1_o_5, v2_o_5, 0:32, 0:8]])
                        C_warp_4 = match_buffer(C_reindex_shared_dyn_warp_1[0, v1_o_5, v2_o_5, 0:32, 0:8])
                        for (tx_5, 0, 32) "thread_binding" {
                          @tir.mma_fill(8, C_warp_5, elem_offset_10, dtype=float16)
                        }
                  }
                }
                for (ax3_0_0_1, 0, 4) {
                  for (ax0_ax1_ax2_fused_0_2, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_2, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_2, 0, 2) "unroll" {
                        for (ax0_ax1_ax2_fused_3_2, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_2, 0, 8) "vectorized" {
                            block([1, 512, 512], "A_reindex_shared.dyn_1") as [v0_2, v1_2, v2_2] {
                              bind(v0_2, 0)
                              bind(v1_2, ((ax1_0_0_ax2_0_0_fused_1*16) + floordiv((((((ax0_ax1_ax2_fused_0_2*2048) + (ax0_ax1_ax2_fused_1_2*512)) + (ax0_ax1_ax2_fused_2_2*256)) + (ax0_ax1_ax2_fused_3_2*8)) + ax0_ax1_ax2_fused_4_2), 128)))
                              bind(v2_2, ((ax3_0_0_1*128) + floormod((((((ax0_ax1_ax2_fused_0_2*2048) + (ax0_ax1_ax2_fused_1_2*512)) + (ax0_ax1_ax2_fused_2_2*256)) + (ax0_ax1_ax2_fused_3_2*8)) + ax0_ax1_ax2_fused_4_2), 128)))
                  ...
                  for (ax0_ax1_ax2_fused_0_3, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_3, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_3, 0, 16) "unroll" {
                        for (ax0_ax1_ax2_fused_3_3, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3, 0, 8) "vectorized" {
                            block([1, 512, 128], "B_reindex_shared.dyn_1") as [v0_3, v1_3, v2_3] {
                              bind(v0_3, 0)
                              bind(v1_3, ((ax3_0_0_1*128) + floordiv((((((ax0_ax1_ax2_fused_0_3*16384) + (ax0_ax1_ax2_fused_1_3*4096)) + (ax0_ax1_ax2_fused_2_3*256)) + (ax0_ax1_ax2_fused_3_3*8)) + ax0_ax1_ax2_fused_4_3), 128)))
                              bind(v2_3, floormod((((((ax0_ax1_ax2_fused_0_3*16384) + (ax0_ax1_ax2_fused_1_3*4096)) + (ax0_ax1_ax2_fused_2_3*256)) + (ax0_ax1_ax2_fused_3_3*8)) + ax0_ax1_ax2_fused_4_3), 128))
                    ...
                    for (ax0_0_3, 0, 1) {
                      for (ax1_0_5, 0, 1) {
                        block([1, 32, 32], "A_reindex_shared.dyn_warp_o_1") as [v0_o_6, v1_o_6, v2_o_6] {
                          ...
                          warp_4 = match_buffer(A_reindex_shared_dyn_warp_1[v0_o_6, v1_o_6, v2_o_6, 0:32, 0:8])
                          shared_4 = match_buffer(A_reindex_shared_dyn_1[v0_o_6, (v1_o_6*16):((v1_o_6*16) + 16), (v2_o_6*16):((v2_o_6*16) + 16)])
                          for (tx_6, 0, 32) "thread_binding" {
                            @tir.ptx_ldmatrix(False, 4, ".b16", warp_5, (elem_offset_11 + (8*tx_6)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_5, elem_offset_12, (shared_s0_2*16), 1, dtype=handle), ((shared_s0_2*floormod(tx_6, 16)) + (8*floordiv(tx_6, 16))), dtype=float16)
                          }
                      }
                    }
                    for (ax0_0_4, 0, 1) {
                      for (ax1_0_6, 0, 2) {
                        block([1, 32, 8], "B_reindex_shared.dyn_warp_o_1") as [v0_o_7, v1_o_7, v2_o_7] {
                          ...
                          warp_6 = match_buffer(B_reindex_shared_dyn_warp_1[v0_o_7, v1_o_7, v2_o_7, 0:32, 0:8])
                          shared_6 = match_buffer(B_reindex_shared_dyn_1[v0_o_7, (v1_o_7*16):((v1_o_7*16) + 16), (v2_o_7*16):((v2_o_7*16) + 16)])
                          for (tx_7, 0, 32) "thread_binding" {
                            @tir.ptx_ldmatrix(True, 4, ".b16", warp_7, (elem_offset_13 + (8*tx_7)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_7, elem_offset_14, (shared_s0_3*16), 1, dtype=handle), ((shared_s0_3*floormod(tx_7, 16)) + (8*floordiv(tx_7, 16))), dtype=float16)
                          }
                      }
                    }
                    for (ax1_0_3_1, 0, 1) {
                      for (ax2_0_3_1, 0, 2) {
                        block([1, 32, 8, tir.reduce_axis(0, 32)], "gemm_o_update_1") as [v0_o_8, v1_o_8, v2_o_8, v3_o_1] {
                          ...
                          block([1, 1, tir.reduce_axis(0, 1)], "gemm_o_1") as [v1_i_o_1, v2_i_o_1, v3_i_o_1] {
                            ...
                            B_1_3 = match_buffer(B_reindex_shared_dyn_warp_1[0, v3_o_1, v2_o_8, 0:32, 0:8])
                            C_1_4 = match_buffer(C_reindex_shared_dyn_warp_1[0, v1_o_8, v2_o_8, 0:32, 0:8])
                            for (tx_8, 0, 32) "thread_binding" {
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_4, (elem_offset_15 + (tx_8*8)), B_1_4, (elem_offset_16 + (tx_8*8)), C_1_5, (elem_offset_17 + (tx_8*8)), False, dtype=float16)
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_4, (elem_offset_15 + (tx_8*8)), B_1_4, ((elem_offset_16 + (tx_8*8)) + 4), C_1_5, ((elem_offset_17 + (tx_8*8)) + 4), False, dtype=float16)
                            }
                      }
                    }
                ...
                for (ax0_0_5, 0, 1) {
                  for (ax1_0_7, 0, 2) {
                    block([1, 32, 8], "C_reindex_shared.dyn_warp_o_1") as [v0_o_9, v1_o_9, v2_o_9] {
                      ...
                      C_warp_6 = match_buffer(C_reindex_shared_dyn_warp_1[v0_o_9, v1_o_9, v2_o_9, 0:32, 0:8])
                      C_1_6 = match_buffer(C_reindex_shared_dyn_1[v0_o_9, (v1_o_9*16):((v1_o_9*16) + 16), (v2_o_9*16):((v2_o_9*16) + 16)])
                      for (tx_9, 0, 32) "thread_binding" {
                        @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_1_7, elem_offset_18, (C_1_s0_1*16), 2, dtype=handle), C_warp_7, elem_offset_19, C_1_s0_1, dtype=float16)
                      }
                  }
                }
              }
              for (ax0_ax1_ax2_fused_0_7: int32, 0, 8) "unroll" {
                for (ax0_ax1_ax2_fused_1_7: int32, 0, 32) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_7: int32, 0, 8) "vectorized" {
                    block([1, 512, 128], "C_reindex_shared.dyn_1") as [v0_7, v1_7, v2_7] {
                      bind(v0_7, 0)
                      bind(v1_7, ((ax1_0_0_ax2_0_0_fused_1*16) + floordiv((((ax0_ax1_ax2_fused_0_7*256) + (ax0_ax1_ax2_fused_1_7*8)) + ax0_ax1_ax2_fused_2_7), 128)))
                      bind(v2_7, floormod((((ax0_ax1_ax2_fused_0_7*256) + (ax0_ax1_ax2_fused_1_7*8)) + ax0_ax1_ax2_fused_2_7), 128))
                      tir.reads([C_reindex_shared_dyn_1[v0_7, v1_7, v2_7]])
                      tir.writes([C_intermediate_1[v1_7, v2_7]])
                      C_intermediate_1[v1_7, v2_7] = C_reindex_shared_dyn_1[v0_7, v1_7, v2_7]
                  }
                }
              }
            }
      ...
      for (ax0_2, 0, 1) "thread_binding" {
        for (ax1_0_0_ax2_0_0_fused_2, 0, 32) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused_2: int32, 0, 1) "thread_binding" {
            for (ax1_0_2_2, 0, 1) "thread_binding" {
              for (ax2_0_2_2, 0, 4) "thread_binding" {
                for (ax1_0_3_init_2, 0, 1) {
                  for (ax2_0_3_init_2, 0, 2) {
                    block([1, 32, 8], "gemm_o_init_2") as [v0_o_10, v1_o_10, v2_o_10] {
                      bind(v0_o_10, ax0_2)
                      ...
                      block([1, 1], "gemm_init_o_2") as [v1_i_init_o_2, v2_i_init_o_2] {
                        ...
                        tir.writes([C_reindex_shared_dyn_warp_2[0, v1_o_10, v2_o_10, 0:32, 0:8]])
                        C_warp_8 = match_buffer(C_reindex_shared_dyn_warp_2[0, v1_o_10, v2_o_10, 0:32, 0:8])
                        for (tx_10, 0, 32) "thread_binding" {
                          @tir.mma_fill(8, C_warp_9, elem_offset_20, dtype=float16)
                        }
                  }
                }
                for (ax3_0_0_2, 0, 1) {
                  for (ax0_ax1_ax2_fused_0_4, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_4, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_4, 0, 2) "unroll" {
                        for (ax0_ax1_ax2_fused_3_4, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_4, 0, 8) "vectorized" {
                            block([1, 512, 128], "A_reindex_shared.dyn_2") as [v0_4, v1_4, v2_4] {
                              bind(v0_4, 0)
                              bind(v1_4, ((ax1_0_0_ax2_0_0_fused_2*16) + floordiv((((((ax0_ax1_ax2_fused_0_4*2048) + (ax0_ax1_ax2_fused_1_4*512)) + (ax0_ax1_ax2_fused_2_4*256)) + (ax0_ax1_ax2_fused_3_4*8)) + ax0_ax1_ax2_fused_4_4), 128)))
                              bind(v2_4, floormod((((((ax0_ax1_ax2_fused_0_4*2048) + (ax0_ax1_ax2_fused_1_4*512)) + (ax0_ax1_ax2_fused_2_4*256)) + (ax0_ax1_ax2_fused_3_4*8)) + ax0_ax1_ax2_fused_4_4), 128))
                  ...
                  for (ax0_ax1_ax2_fused_0_5, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_5, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_5, 0, 16) "unroll" {
                        for (ax0_ax1_ax2_fused_3_5, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_5, 0, 8) "vectorized" {
                            block([1, 128, 128], "B_reindex_shared.dyn_2") as [v0_5, v1_5, v2_5] {
                              bind(v0_5, 0)
                              bind(v1_5, floordiv((((((ax0_ax1_ax2_fused_0_5*16384) + (ax0_ax1_ax2_fused_1_5*4096)) + (ax0_ax1_ax2_fused_2_5*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 128))
                              bind(v2_5, floormod((((((ax0_ax1_ax2_fused_0_5*16384) + (ax0_ax1_ax2_fused_1_5*4096)) + (ax0_ax1_ax2_fused_2_5*256)) + (ax0_ax1_ax2_fused_3_5*8)) + ax0_ax1_ax2_fused_4_5), 128))
                    ...
                    for (ax0_0_6, 0, 1) {
                      for (ax1_0_8, 0, 1) {
                        block([1, 32, 8], "A_reindex_shared.dyn_warp_o_2") as [v0_o_11, v1_o_11, v2_o_11] {
                          ...
                          warp_8 = match_buffer(A_reindex_shared_dyn_warp_2[v0_o_11, v1_o_11, v2_o_11, 0:32, 0:8])
                          shared_8 = match_buffer(A_reindex_shared_dyn_2[v0_o_11, (v1_o_11*16):((v1_o_11*16) + 16), (v2_o_11*16):((v2_o_11*16) + 16)])
                          for (tx_11, 0, 32) "thread_binding" {
                            @tir.ptx_ldmatrix(False, 4, ".b16", warp_9, (elem_offset_21 + (8*tx_11)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_9, elem_offset_22, (shared_s0_4*16), 1, dtype=handle), ((shared_s0_4*floormod(tx_11, 16)) + (8*floordiv(tx_11, 16))), dtype=float16)
                          }
                      }
                    }
                    for (ax0_0_7, 0, 1) {
                      for (ax1_0_9, 0, 2) {
                        block([1, 8, 8], "B_reindex_shared.dyn_warp_o_2") as [v0_o_12, v1_o_12, v2_o_12] {
                          ...
                          warp_10 = match_buffer(B_reindex_shared_dyn_warp_2[v0_o_12, v1_o_12, v2_o_12, 0:32, 0:8])
                          shared_10 = match_buffer(B_reindex_shared_dyn_2[v0_o_12, (v1_o_12*16):((v1_o_12*16) + 16), (v2_o_12*16):((v2_o_12*16) + 16)])
                          for (tx_12, 0, 32) "thread_binding" {
                            @tir.ptx_ldmatrix(True, 4, ".b16", warp_11, (elem_offset_23 + (8*tx_12)), @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), shared_11, elem_offset_24, (shared_s0_5*16), 1, dtype=handle), ((shared_s0_5*floormod(tx_12, 16)) + (8*floordiv(tx_12, 16))), dtype=float16)
                          }
                      }
                    }
                    for (ax1_0_3_2, 0, 1) {
                      for (ax2_0_3_2, 0, 2) {
                        block([1, 32, 8, tir.reduce_axis(0, 8)], "gemm_o_update_2") as [v0_o_13, v1_o_13, v2_o_13, v3_o_2] {
                          ...
                          block([1, 1, tir.reduce_axis(0, 1)], "gemm_o_2") as [v1_i_o_2, v2_i_o_2, v3_i_o_2] {
                            ...
                            B_1_5 = match_buffer(B_reindex_shared_dyn_warp_2[0, v3_o_2, v2_o_13, 0:32, 0:8])
                            C_1_8 = match_buffer(C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8])
                            for (tx_13, 0, 32) "thread_binding" {
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_6, (elem_offset_25 + (tx_13*8)), B_1_6, (elem_offset_26 + (tx_13*8)), C_1_9, (elem_offset_27 + (tx_13*8)), False, dtype=float16)
                              @tir.ptx_mma("m16n8k16", "row", "col", "fp16", "fp16", "fp16", A_1_6, (elem_offset_25 + (tx_13*8)), B_1_6, ((elem_offset_26 + (tx_13*8)) + 4), C_1_9, ((elem_offset_27 + (tx_13*8)) + 4), False, dtype=float16)
                            }
                      }
                    }
                ...
                for (ax0_0_8, 0, 1) {
                  for (ax1_0_10, 0, 2) {
                    block([1, 32, 8], "C_reindex_shared.dyn_warp_o_2") as [v0_o_14, v1_o_14, v2_o_14] {
                      ...
                      C_warp_10 = match_buffer(C_reindex_shared_dyn_warp_2[v0_o_14, v1_o_14, v2_o_14, 0:32, 0:8])
                      C_1_10 = match_buffer(C_reindex_shared_dyn_2[v0_o_14, (v1_o_14*16):((v1_o_14*16) + 16), (v2_o_14*16):((v2_o_14*16) + 16)])
                      for (tx_14, 0, 32) "thread_binding" {
                        @tir.mma_store(16, 16, @tir.tvm_access_ptr(@tir.type_annotation(, dtype=float16), C_1_11, elem_offset_28, (C_1_s0_2*16), 2, dtype=handle), C_warp_11, elem_offset_29, C_1_s0_2, dtype=float16)
                      }
                  }
                }
              }
