        ...
        for (ax1_0_0_ax2_0_0_fused: int32, 0, 32) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused: int32, 0, 1) "thread_binding" {
            for (ax1_0_2: int32, 0, 1) "thread_binding" {
                      ...
                      for (ax0_ax1_ax2_fused_2_3: int32, 0, 16) "unroll" {
                        for (ax0_ax1_ax2_fused_3_3: int32, 0, 32) "thread_binding" {
                          for (ax0_ax1_ax2_fused_4_3: int32, 0, 8) "vectorized" {
                            block([1, 128, 128], "B_reindex_shared.dyn_2") as [v0_3, v1_3, v2_3] {
                              bind(v0_3, 0)
                              bind(v1_3, floordiv((((((ax0_ax1_ax2_fused_0_3*16384) + (ax0_ax1_ax2_fused_1_3*4096)) + (ax0_ax1_ax2_fused_2_3*256)) + (ax0_ax1_ax2_fused_3_3*8)) + ax0_ax1_ax2_fused_4_3), 128))
                              ...
                              tir.reads([F[v1_3, v2_3]])
                              tir.writes([B_reindex_shared_dyn_2[v0_3, v1_3, v2_3]])
                              tir.attrs({"permuted_layout": 0, "buffer_dim_align": [[0, 1, 16, 8]]})
                              B_reindex_shared_dyn_2[v0_3, v1_3, v2_3] = F[v1_3, v2_3]
                          }
                        }
                      }
                    }
              ...
              for (ax0_ax1_ax2_fused_0_4: int32, 0, 32) "unroll" {
                for (ax0_ax1_ax2_fused_1_4: int32, 0, 32) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_4: int32, 0, 8) "vectorized" {
                    block([1, 512, 512], "C_reindex_shared.dyn") as [v0_4, v1_4, v2_4] {
                      bind(v0_4, 0)
                      bind(v1_4, ((ax1_0_0_ax2_0_0_fused*16) + floordiv((((ax0_ax1_ax2_fused_0_4*256) + (ax0_ax1_ax2_fused_1_4*8)) + ax0_ax1_ax2_fused_2_4), 512)))
                      bind(v2_4, floormod((((ax0_ax1_ax2_fused_0_4*256) + (ax0_ax1_ax2_fused_1_4*8)) + ax0_ax1_ax2_fused_2_4), 512))
                      tir.reads([C_reindex_shared_dyn[v0_4, v1_4, v2_4]])
                      tir.writes([C_intermediate[v1_4, v2_4]])
                      C_intermediate[v1_4, v2_4] = C_reindex_shared_dyn[v0_4, v1_4, v2_4]
                  }
                }
              }
            }
                ...
                for (ax3_0_0_1, 0, 4) {
                  for (ax0_ax1_ax2_fused_0_2, 0, 1) "thread_binding" {
                    for (ax0_ax1_ax2_fused_1_2, 0, 4) "thread_binding" {
                      for (ax0_ax1_ax2_fused_2_2, 0, 16) "unroll" {
        ...
        for (ax1_0_0_ax2_0_0_fused_2, 0, 32) "thread_binding" {
          for (ax1_0_1_ax2_0_1_fused_2: int32, 0, 1) "thread_binding" {
            for (ax1_0_2_2, 0, 1) "thread_binding" {
              ...
              for (ax0_ax1_ax2_fused_0_6: int32, 0, 8) "unroll" {
                for (ax0_ax1_ax2_fused_1_6: int32, 0, 32) "thread_binding" {
                  for (ax0_ax1_ax2_fused_2_6: int32, 0, 8) "vectorized" {
                    block([1, 512, 128], "C_reindex_shared.dyn_2") as [v0_6, v1_6, v2_6] {
                      bind(v0_6, 0)
                      bind(v1_6, ((ax1_0_0_ax2_0_0_fused_2*16) + floordiv((((ax0_ax1_ax2_fused_0_6*256) + (ax0_ax1_ax2_fused_1_6*8)) + ax0_ax1_ax2_fused_2_6), 128)))
                      bind(v2_6, floormod((((ax0_ax1_ax2_fused_0_6*256) + (ax0_ax1_ax2_fused_1_6*8)) + ax0_ax1_ax2_fused_2_6), 128))
                      tir.reads([C_reindex_shared_dyn_2[v0_6, v1_6, v2_6]])
                      tir.writes([C_intermediate_1_2[v1_6, v2_6]])
                      C_intermediate_1_2[v1_6, v2_6] = C_reindex_shared_dyn_2[v0_6, v1_6, v2_6]
                  }
                }
              }
            }
