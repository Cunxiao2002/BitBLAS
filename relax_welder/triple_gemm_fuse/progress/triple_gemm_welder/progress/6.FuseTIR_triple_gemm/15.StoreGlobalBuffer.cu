              ...
              for (ax1_0_3_init_1: int32, 0, 1) {
                for (ax2_0_3_init_1: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init_1") as [v0_o_5, v1_o_5, v2_o_5] {
                    bind(v0_o_5, ax0)
                    bind(v1_o_5, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3_init_1))
                    bind(v2_o_5, ((ax2_0_2*2) + ax2_0_3_init_1))
                    tir.reads([])
                  ...
                  for (ax0_0_3: int32, 0, 1) {
                    for (ax1_0_5: int32, 0, 1) {
                      block([1, 32, 32], "A_reindex_shared.dyn_warp_o_1") as [v0_o_6, v1_o_6, v2_o_6] {
                        bind(v0_o_6, 0)
                        bind(v1_o_6, (ax1_0_0_ax2_0_0_fused + ax0_0_3))
                  ...
                  for (ax1_0_3_1: int32, 0, 1) {
                    for (ax2_0_3_1: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 32)], "gemm_o_update_1") as [v0_o_8, v1_o_8, v2_o_8, v3_o_1] {
                        bind(v0_o_8, ax0)
                        bind(v1_o_8, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3_1))
                        bind(v2_o_8, ((ax2_0_2*2) + ax2_0_3_1))
              ...
              for (ax0_0_5: int32, 0, 1) {
                for (ax1_0_7: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o_1") as [v0_o_9, v1_o_9, v2_o_9] {
                    bind(v0_o_9, 0)
                    bind(v1_o_9, ax1_0_0_ax2_0_0_fused)
                    bind(v2_o_9, ((ax2_0_2*2) + ax1_0_7))
              ...
              for (ax1_0_3_init_2: int32, 0, 1) {
                for (ax2_0_3_init_2: int32, 0, 2) {
                  block([1, 32, 8], "gemm_o_init_2") as [v0_o_10, v1_o_10, v2_o_10] {
                    bind(v0_o_10, ax0)
                    bind(v1_o_10, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3_init_2))
                    bind(v2_o_10, ((ax2_0_2*2) + ax2_0_3_init_2))
                    tir.reads([])
                  ...
                  for (ax0_0_6: int32, 0, 1) {
                    for (ax1_0_8: int32, 0, 1) {
                      block([1, 32, 8], "A_reindex_shared.dyn_warp_o_2") as [v0_o_11, v1_o_11, v2_o_11] {
                        bind(v0_o_11, 0)
                        bind(v1_o_11, (ax1_0_0_ax2_0_0_fused + ax0_0_6))
                        bind(v2_o_11, (ax3_0_1_2 + ax1_0_8))
                        tir.reads([C_reindex_shared_dyn_1[v0_o_11, (v1_o_11*16):((v1_o_11*16) + 16), (v2_o_11*16):((v2_o_11*16) + 16)]])
                        tir.writes([C_reindex_shared_dyn_warp_1[v0_o_11, v1_o_11, v2_o_11, 0:32, 0:8]])
                        tir.attrs({"permuted_layout": 0})
                        warp_8 = match_buffer(C_reindex_shared_dyn_warp_1[v0_o_11, v1_o_11, v2_o_11, 0:32, 0:8])
                        shared_8 = match_buffer(C_reindex_shared_dyn_1[v0_o_11, (v1_o_11*16):((v1_o_11*16) + 16), (v2_o_11*16):((v2_o_11*16) + 16)])
                  ...
                  for (ax0_0_7: int32, 0, 1) {
                    for (ax1_0_9: int32, 0, 2) {
                      block([1, 8, 8], "B_reindex_shared.dyn_warp_o_2") as [v0_o_12, v1_o_12, v2_o_12] {
                        ...
                        bind(v2_o_12, ((ax2_0_2*2) + ax1_0_9))
                  ...
                  for (ax1_0_3_2: int32, 0, 1) {
                    for (ax2_0_3_2: int32, 0, 2) {
                      block([1, 32, 8, tir.reduce_axis(0, 8)], "gemm_o_update_2") as [v0_o_13, v1_o_13, v2_o_13, v3_o_2] {
                        bind(v0_o_13, ax0)
                        bind(v1_o_13, ((ax1_0_0_ax2_0_0_fused + ax1_0_2) + ax1_0_3_2))
                        bind(v2_o_13, ((ax2_0_2*2) + ax2_0_3_2))
                        bind(v3_o_2, ((ax3_0_0_2*8) + ax3_0_1_2))
                        tir.reads([C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8], C_reindex_shared_dyn_warp_1[0, v1_o_13, v3_o_2, 0:32, 0:8], B_reindex_shared_dyn_warp_2[0, v3_o_2, v2_o_13, 0:32, 0:8]])
                        ...
                        block([1, 1, tir.reduce_axis(0, 1)], "gemm_o_2") as [v1_i_o_2, v2_i_o_2, v3_i_o_2] {
                          ...
                          tir.reads([C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8], C_reindex_shared_dyn_warp_1[0, v1_o_13, v3_o_2, 0:32, 0:8], B_reindex_shared_dyn_warp_2[0, v3_o_2, v2_o_13, 0:32, 0:8]])
                          tir.writes([C_reindex_shared_dyn_warp_2[0, v1_o_13, v2_o_13, 0:32, 0:8]])
                          A_1_5 = match_buffer(C_reindex_shared_dyn_warp_1[0, v1_o_13, v3_o_2, 0:32, 0:8])
              ...
              for (ax0_0_8: int32, 0, 1) {
                for (ax1_0_10: int32, 0, 2) {
                  block([1, 32, 8], "C_reindex_shared.dyn_warp_o_2") as [v0_o_14, v1_o_14, v2_o_14] {
                    bind(v0_o_14, 0)
                    bind(v1_o_14, ax1_0_0_ax2_0_0_fused)
                    bind(v2_o_14, ((ax2_0_2*2) + ax1_0_10))
              ...
              for (ax0_ax1_ax2_fused_1_4: int32, 0, 32) "thread_binding" {
                for (ax0_ax1_ax2_fused_2_4: int32, 0, 8) "vectorized" {
                  block([1, 512, 512], "C_reindex_shared.dyn") as [v0_4, v1_4, v2_4] {
                    ...
                    tir.reads([C_reindex_shared_dyn_2[v0_4, v1_4, v2_4]])
                    tir.writes([C_intermediate_1_2[v1_4, v2_4]])
                    C_intermediate_1_2[v1_4, v2_4] = C_reindex_shared_dyn_2[v0_4, v1_4, v2_4]
                }
              }
            }
          }
