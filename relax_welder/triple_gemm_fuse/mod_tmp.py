...
class Module:
    ...
    def fused_dense_relu(input0: T.Buffer((T.int64(2073600), T.int64(64)), "float16"), param_0: T.Buffer((T.int64(64), T.int64(64)), "float16"), T_relu_intermediate: T.Buffer((T.int64(2073600), T.int64(64)), "float16")):
        T.func_attr({"dlight.tensorcore_prenormlized": T.bool(True), "target": T.target({"arch": "sm_80", "keys": ["cuda", "gpu"], "kind": "cuda", "max_num_threads": 1024, "tag": "", "thread_warp_size": 32}), "tir.noalias": T.bool(True)})
        # with T.block("root"):
        ...
        for ax0 in T.thread_binding(T.int64(1), thread="blockIdx.z"):
            for ax1_0_0_ax2_0_0_fused in T.thread_binding(T.int64(10800), thread="blockIdx.y"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(1), thread="blockIdx.x"):
                    for ax1_0_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                        for ax2_0_2 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                            for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(6), T.int64(2)):
                                with T.block("T_matmul_NT_o_init"):
                                    v0_o = T.axis.spatial(T.int64(1), ax0)
                                    v1_o = T.axis.spatial(T.int64(129600), ax1_0_0_ax2_0_0_fused * T.int64(12) + ax1_0_2 * T.int64(6) + ax1_0_3_init)
                            ...
                            for ax3_0_0 in range(T.int64(2)):
                                for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                                    for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                                        for ax0_ax1_ax2_fused_2 in T.unroll(T.int64(6), annotations={"pragma_unroll_explicit": 0}):
                                            for ax0_ax1_ax2_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                                for ax0_ax1_ax2_fused_4 in T.vectorized(T.int64(8)):
                                                    with T.block("input0_reindex_shared.dyn"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(2073600), ax1_0_0_ax2_0_0_fused * T.int64(192) + (ax0_ax1_ax2_fused_0 * T.int64(3072) + ax0_ax1_ax2_fused_1 * T.int64(1536) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) // T.int64(32))
                                                        v2 = T.axis.spatial(T.int64(64), ax3_0_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(3072) + ax0_ax1_ax2_fused_1 * T.int64(1536) + ax0_ax1_ax2_fused_2 * T.int64(256) + ax0_ax1_ax2_fused_3 * T.int64(8) + ax0_ax1_ax2_fused_4) % T.int64(32))
                                ...
                                for ax3_0_1 in range(T.int64(2)):
                                    for ax0_0, ax1_0 in T.grid(T.int64(6), T.int64(1)):
                                        with T.block("input0_reindex_shared.dyn_warp_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(129600), ax1_0_0_ax2_0_0_fused * T.int64(12) + ax1_0_2 * T.int64(6) + ax0_0)
                                    ...
                                    for ax1_0_3, ax2_0_3 in T.grid(T.int64(6), T.int64(2)):
                                        with T.block("T_matmul_NT_o_update"):
                                            v0_o = T.axis.spatial(T.int64(1), ax0)
                                            v1_o = T.axis.spatial(T.int64(129600), ax1_0_0_ax2_0_0_fused * T.int64(12) + ax1_0_2 * T.int64(6) + ax1_0_3)
                            ...
                            for ax0_0, ax1_0 in T.grid(T.int64(6), T.int64(2)):
                        ...
                        for ax0_ax1_ax2_fused_0 in T.unroll(T.int64(24), annotations={"pragma_unroll_explicit": 0}):
                            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_ax2_fused_2 in T.vectorized(T.int64(8)):
                                    with T.block("T_matmul_NT_intermediate_reindex_shared.dyn"):
                                        v0 = T.axis.spatial(T.int64(1), T.int64(0))
                                        v1 = T.axis.spatial(T.int64(2073600), ax1_0_0_ax2_0_0_fused * T.int64(192) + ax1_0_2 * T.int64(96) + (ax0_ax1_ax2_fused_0 * T.int64(256) + ax0_ax1_ax2_fused_1 * T.int64(8) + ax0_ax1_ax2_fused_2) // T.int64(64))
    ...
    @R.function
    def main(input: R.Tensor((2073600, 64), dtype="float16"), param_func0: R.Tensor((64, 64), dtype="float16"), param_func1: R.Tensor((64, 64), dtype="float16")) -> R.Tensor((2073600, 64), dtype="float16"):
        cls = Module
        with R.dataflow():
            lv = R.call_tir(cls.fused_dense_relu, (input, param_func0), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            lv1 = R.call_tir(cls.fused_dense_relu, (lv, param_func1), out_sinfo=R.Tensor((2073600, 64), dtype="float16"))
            gv: R.Tensor((2073600, 64), dtype="float16") = lv1
            R.output(gv)
        return gv